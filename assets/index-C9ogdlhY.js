...
}`,h3=[new X(1,0,0),new X(-1,0,0),new X(0,1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1)],p3=[new X(0,-1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1),new X(0,-1,0),new X(0,-1,0)],Sg=new Ht,$r=new X,Of=new X;function m3(t,e,n){let i=new Y_;const a=new ot,s=new ot,r=new Ot,o=new w1,l=new N1,c={},d=n.maxTextureSize,p={[ka]:bn,[bn]:ka,[Gi]:Gi},u=new Ai({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ot},radius:{value:4}},vertexShader:f3,fragmentShader:d3}),h=u.clone();h.defines.HORIZONTAL_PASS=1;const _=new ui;_.setAttribute("position",new li(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const T=new sa(_,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ac;let f=this.type;this.render=function(C,w,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||C.length===0)return;this.type===xb&&(Le("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ac);const R=t.getRenderTarget(),N=t.getActiveCubeFace(),D=t.getActiveMipmapLevel(),B=t.state;B.setBlending(Zi),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const Y=f!==this.type;Y&&w.traverse(function(ee){ee.material&&(Array.isArray(ee.material)?ee.material.forEach(H=>H.needsUpdate=!0):ee.material.needsUpdate=!0)});for(let ee=0,H=C.length;ee<H;ee++){const O=C[ee],I=O.shadow;if(I===void 0){Le("WebGLShadowMap:",O,"has no shadow.");continue}if(I.autoUpdate===!1&&I.needsUpdate===!1)continue;a.copy(I.mapSize);const G=I.getFrameExtents();a.multiply(G),s.copy(I.mapSize),(a.x>d||a.y>d)&&(a.x>d&&(s.x=Math.floor(d/G.x),a.x=s.x*G.x,I.mapSize.x=s.x),a.y>d&&(s.y=Math.floor(d/G.y),a.y=s.y*G.y,I.mapSize.y=s.y));const J=t.state.buffers.depth.getReversed();if(I.camera._reversedDepth=J,I.map===null||Y===!0){if(I.map!==null&&(I.map.depthTexture!==null&&(I.map.depthTexture.dispose(),I.map.depthTexture=null),I.map.dispose()),this.type===so){if(O.isPointLight){Le("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}I.map=new Ei(a.x,a.y,{format:vs,type:ia,minFilter:fn,magFilter:fn,generateMipmaps:!1}),I.map.texture.name=O.name+".shadowMap",I.map.depthTexture=new Cr(a.x,a.y,Si),I.map.depthTexture.name=O.name+".shadowMapDepth",I.map.depthTexture.format=aa,I.map.depthTexture.compareFunction=null,I.map.depthTexture.minFilter=rn,I.map.depthTexture.magFilter=rn}else O.isPointLight?(I.map=new iS(a.x),I.map.depthTexture=new b1(a.x,Ti)):(I.map=new Ei(a.x,a.y),I.map.depthTexture=new Cr(a.x,a.y,Ti)),I.map.depthTexture.name=O.name+".shadowMap",I.map.depthTexture.format=aa,this.type===ac?(I.map.depthTexture.compareFunction=J?Up:Dp,I.map.depthTexture.minFilter=fn,I.map.depthTexture.magFilter=fn):(I.map.depthTexture.compareFunction=null,I.map.depthTexture.minFilter=rn,I.map.depthTexture.magFilter=rn);I.camera.updateProjectionMatrix()}const ie=I.map.isWebGLCubeRenderTarget?6:1;for(let fe=0;fe<ie;fe++){if(I.map.isWebGLCubeRenderTarget)t.setRenderTarget(I.map,fe),t.clear();else{fe===0&&(t.setRenderTarget(I.map),t.clear());const ve=I.getViewport(fe);r.set(s.x*ve.x,s.y*ve.y,s.x*ve.z,s.y*ve.w),B.viewport(r)}if(O.isPointLight){const ve=I.camera,We=I.matrix,it=O.distance||ve.far;it!==ve.far&&(ve.far=it,ve.updateProjectionMatrix()),$r.setFromMatrixPosition(O.matrixWorld),ve.position.copy($r),Of.copy(ve.position),Of.add(h3[fe]),ve.up.copy(p3[fe]),ve.lookAt(Of),ve.updateMatrixWorld(),We.makeTranslation(-$r.x,-$r.y,-$r.z),Sg.multiplyMatrices(ve.projectionMatrix,ve.matrixWorldInverse),I._frustum.setFromProjectionMatrix(Sg,ve.coordinateSystem,ve.reversedDepth)}else I.updateMatrices(O);i=I.getFrustum(),S(w,x,I.camera,O,this.type)}I.isPointLightShadow!==!0&&this.type===so&&v(I,x),I.needsUpdate=!1}f=this.type,g.needsUpdate=!1,t.setRenderTarget(R,N,D)};function v(C,w){const x=e.update(T);u.defines.VSM_SAMPLES!==C.blurSamples&&(u.defines.VSM_SAMPLES=C.blurSamples,h.defines.VSM_SAMPLES=C.blurSamples,u.needsUpdate=!0,h.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Ei(a.x,a.y,{format:vs,type:ia})),u.uniforms.shadow_pass.value=C.map.depthTexture,u.uniforms.resolution.value=C.mapSize,u.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(w,null,x,u,T,null),h.uniforms.shadow_pass.value=C.mapPass.texture,h.uniforms.resolution.value=C.mapSize,h.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(w,null,x,h,T,null)}function b(C,w,x,R){let N=null;const D=x.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(D!==void 0)N=D;else if(N=x.isPointLight===!0?l:o,t.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const B=N.uuid,Y=w.uuid;let ee=c[B];ee===void 0&&(ee={},c[B]=ee);let H=ee[Y];H===void 0&&(H=N.clone(),ee[Y]=H,w.addEventListener("dispose",A)),N=H}if(N.visible=w.visible,N.wireframe=w.wireframe,R===so?N.side=w.shadowSide!==null?w.shadowSide:w.side:N.side=w.shadowSide!==null?w.shadowSide:p[w.side],N.alphaMap=w.alphaMap,N.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,N.map=w.map,N.clipShadows=w.clipShadows,N.clippingPlanes=w.clippingPlanes,N.clipIntersection=w.clipIntersection,N.displacementMap=w.displacementMap,N.displacementScale=w.displacementScale,N.displacementBias=w.displacementBias,N.wireframeLinewidth=w.wireframeLinewidth,N.linewidth=w.linewidth,x.isPointLight===!0&&N.isMeshDistanceMaterial===!0){const B=t.properties.get(N);B.light=x}return N}function S(C,w,x,R,N){if(C.visible===!1)return;if(C.layers.test(w.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&N===so)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,C.matrixWorld);const Y=e.update(C),ee=C.material;if(Array.isArray(ee)){const H=Y.groups;for(let O=0,I=H.length;O<I;O++){const G=H[O],J=ee[G.materialIndex];if(J&&J.visible){const ie=b(C,J,R,N);C.onBeforeShadow(t,C,w,x,Y,ie,G),t.renderBufferDirect(x,null,Y,ie,C,G),C.onAfterShadow(t,C,w,x,Y,ie,G)}}}else if(ee.visible){const H=b(C,ee,R,N);C.onBeforeShadow(t,C,w,x,Y,H,null),t.renderBufferDirect(x,null,Y,H,C,null),C.onAfterShadow(t,C,w,x,Y,H,null)}}const B=C.children;for(let Y=0,ee=B.length;Y<ee;Y++)S(B[Y],w,x,R,N)}function A(C){C.target.removeEventListener("dispose",A);for(const x in c){const R=c[x],N=C.target.uuid;N in R&&(R[N].dispose(),delete R[N])}}}function g3(t,e){function n(){let L=!1;const re=new Ot;let Z=null;const ue=new Ot(0,0,0,0);return{setMask:function(he){Z!==he&&!L&&(t.colorMask(he,he,he,he),Z=he)},setLocked:function(he){L=he},setClear:function(he,te,ye,me,Rt){Rt===!0&&(he*=me,te*=me,ye*=me),re.set(he,te,ye,me),ue.equals(re)===!1&&(t.clearColor(he,te,ye,me),ue.copy(re))},reset:function(){L=!1,Z=null,ue.set(-1,0,0,0)}}}function i(){let L=!1,re=!1,Z=null,ue=null,he=null;return{setReversed:function(te){if(re!==te){const ye=e.get("EXT_clip_control");te?ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.ZERO_TO_ONE_EXT):ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.NEGATIVE_ONE_TO_ONE_EXT),re=te;const me=he;he=null,this.setClear(me)}},getReversed:function(){return re},setTest:function(te){te?ae(t.DEPTH_TEST):Ne(t.DEPTH_TEST)},setMask:function(te){Z!==te&&!L&&(t.depthMask(te),Z=te)},setFunc:function(te){if(re&&(te=Kb[te]),ue!==te){switch(te){case Od:t.depthFunc(t.NEVER);break;case Pd:t.depthFunc(t.ALWAYS);break;case Id:t.depthFunc(t.LESS);break;case Ar:t.depthFunc(t.LEQUAL);break;case zd:t.depthFunc(t.EQUAL);break;case Bd:t.depthFunc(t.GEQUAL);break;case Fd:t.depthFunc(t.GREATER);break;case Hd:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ue=te}},setLocked:function(te){L=te},setClear:function(te){he!==te&&(he=te,re&&(te=1-te),t.clearDepth(te))},reset:function(){L=!1,Z=null,ue=null,he=null,re=!1}}}function a(){let L=!1,re=null,Z=null,ue=null,he=null,te=null,ye=null,me=null,Rt=null;return{setTest:function(vt){L||(vt?ae(t.STENCIL_TEST):Ne(t.STENCIL_TEST))},setMask:function(vt){re!==vt&&!L&&(t.stencilMask(vt),re=vt)},setFunc:function(vt,fi,di){(Z!==vt||ue!==fi||he!==di)&&(t.stencilFunc(vt,fi,di),Z=vt,ue=fi,he=di)},setOp:function(vt,fi,di){(te!==vt||ye!==fi||me!==di)&&(t.stencilOp(vt,fi,di),te=vt,ye=fi,me=di)},setLocked:function(vt){L=vt},setClear:function(vt){Rt!==vt&&(t.clearStencil(vt),Rt=vt)},reset:function(){L=!1,re=null,Z=null,ue=null,he=null,te=null,ye=null,me=null,Rt=null}}}const s=new n,r=new i,o=new a,l=new WeakMap,c=new WeakMap;let d={},p={},u={},h=new WeakMap,_=[],T=null,g=!1,f=null,v=null,b=null,S=null,A=null,C=null,w=null,x=new at(0,0,0),R=0,N=!1,D=null,B=null,Y=null,ee=null,H=null;const O=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let I=!1,G=0;const J=t.getParameter(t.VERSION);J.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(J)[1]),I=G>=1):J.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),I=G>=2);let ie=null,fe={};const ve=t.getParameter(t.SCISSOR_BOX),We=t.getParameter(t.VIEWPORT),it=new Ot().fromArray(ve),ke=new Ot().fromArray(We);function Q(L,re,Z,ue){const he=new Uint8Array(4),te=t.createTexture();t.bindTexture(L,te),t.texParameteri(L,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(L,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let ye=0;ye<Z;ye++)L===t.TEXTURE_3D||L===t.TEXTURE_2D_ARRAY?t.texImage3D(re,0,t.RGBA,1,1,ue,0,t.RGBA,t.UNSIGNED_BYTE,he):t.texImage2D(re+ye,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,he);return te}const ce={};ce[t.TEXTURE_2D]=Q(t.TEXTURE_2D,t.TEXTURE_2D,1),ce[t.TEXTURE_CUBE_MAP]=Q(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ce[t.TEXTURE_2D_ARRAY]=Q(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ce[t.TEXTURE_3D]=Q(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ae(t.DEPTH_TEST),r.setFunc(Ar),Nt(!1),Pt(M0),ae(t.CULL_FACE),$e(Zi);function ae(L){d[L]!==!0&&(t.enable(L),d[L]=!0)}function Ne(L){d[L]!==!1&&(t.disable(L),d[L]=!1)}function Oe(L,re){return u[L]!==re?(t.bindFramebuffer(L,re),u[L]=re,L===t.DRAW_FRAMEBUFFER&&(u[t.FRAMEBUFFER]=re),L===t.FRAMEBUFFER&&(u[t.DRAW_FRAMEBUFFER]=re),!0):!1}function we(L,re){let Z=_,ue=!1;if(L){Z=h.get(re),Z===void 0&&(Z=[],h.set(re,Z));const he=L.textures;if(Z.length!==he.length||Z[0]!==t.COLOR_ATTACHMENT0){for(let te=0,ye=he.length;te<ye;te++)Z[te]=t.COLOR_ATTACHMENT0+te;Z.length=he.length,ue=!0}}else Z[0]!==t.BACK&&(Z[0]=t.BACK,ue=!0);ue&&t.drawBuffers(Z)}function Tt(L){return T!==L?(t.useProgram(L),T=L,!0):!1}const Xe={[is]:t.FUNC_ADD,[_b]:t.FUNC_SUBTRACT,[Sb]:t.FUNC_REVERSE_SUBTRACT};Xe[yb]=t.MIN,Xe[Mb]=t.MAX;const lt={[bb]:t.ZERO,[Eb]:t.ONE,[Tb]:t.SRC_COLOR,[Ud]:t.SRC_ALPHA,[Db]:t.SRC_ALPHA_SATURATE,[wb]:t.DST_COLOR,[Rb]:t.DST_ALPHA,[Ab]:t.ONE_MINUS_SRC_COLOR,[Ld]:t.ONE_MINUS_SRC_ALPHA,[Nb]:t.ONE_MINUS_DST_COLOR,[Cb]:t.ONE_MINUS_DST_ALPHA,[Ub]:t.CONSTANT_COLOR,[Lb]:t.ONE_MINUS_CONSTANT_COLOR,[Ob]:t.CONSTANT_ALPHA,[Pb]:t.ONE_MINUS_CONSTANT_ALPHA};function $e(L,re,Z,ue,he,te,ye,me,Rt,vt){if(L===Zi){g===!0&&(Ne(t.BLEND),g=!1);return}if(g===!1&&(ae(t.BLEND),g=!0),L!==vb){if(L!==f||vt!==N){if((v!==is||A!==is)&&(t.blendEquation(t.FUNC_ADD),v=is,A=is),vt)switch(L){case dr:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Dd:t.blendFunc(t.ONE,t.ONE);break;case b0:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case E0:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:nt("WebGLState: Invalid blending: ",L);break}else switch(L){case dr:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Dd:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case b0:nt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case E0:nt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:nt("WebGLState: Invalid blending: ",L);break}b=null,S=null,C=null,w=null,x.set(0,0,0),R=0,f=L,N=vt}return}he=he||re,te=te||Z,ye=ye||ue,(re!==v||he!==A)&&(t.blendEquationSeparate(Xe[re],Xe[he]),v=re,A=he),(Z!==b||ue!==S||te!==C||ye!==w)&&(t.blendFuncSeparate(lt[Z],lt[ue],lt[te],lt[ye]),b=Z,S=ue,C=te,w=ye),(me.equals(x)===!1||Rt!==R)&&(t.blendColor(me.r,me.g,me.b,Rt),x.copy(me),R=Rt),f=L,N=!1}function Ye(L,re){L.side===Gi?Ne(t.CULL_FACE):ae(t.CULL_FACE);let Z=L.side===bn;re&&(Z=!Z),Nt(Z),L.blending===dr&&L.transparent===!1?$e(Zi):$e(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),r.setFunc(L.depthFunc),r.setTest(L.depthTest),r.setMask(L.depthWrite),s.setMask(L.colorWrite);const ue=L.stencilWrite;o.setTest(ue),ue&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Re(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?ae(t.SAMPLE_ALPHA_TO_COVERAGE):Ne(t.SAMPLE_ALPHA_TO_COVERAGE)}function Nt(L){D!==L&&(L?t.frontFace(t.CW):t.frontFace(t.CCW),D=L)}function Pt(L){L!==mb?(ae(t.CULL_FACE),L!==B&&(L===M0?t.cullFace(t.BACK):L===gb?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Ne(t.CULL_FACE),B=L}function Gt(L){L!==Y&&(I&&t.lineWidth(L),Y=L)}function Re(L,re,Z){L?(ae(t.POLYGON_OFFSET_FILL),(ee!==re||H!==Z)&&(ee=re,H=Z,r.getReversed()&&(re=-re),t.polygonOffset(re,Z))):Ne(t.POLYGON_OFFSET_FILL)}function At(L){L?ae(t.SCISSOR_TEST):Ne(t.SCISSOR_TEST)}function Ie(L){L===void 0&&(L=t.TEXTURE0+O-1),ie!==L&&(t.activeTexture(L),ie=L)}function P(L,re,Z){Z===void 0&&(ie===null?Z=t.TEXTURE0+O-1:Z=ie);let ue=fe[Z];ue===void 0&&(ue={type:void 0,texture:void 0},fe[Z]=ue),(ue.type!==L||ue.texture!==re)&&(ie!==Z&&(t.activeTexture(Z),ie=Z),t.bindTexture(L,re||ce[L]),ue.type=L,ue.texture=re)}function De(){const L=fe[ie];L!==void 0&&L.type!==void 0&&(t.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function et(){try{t.compressedTexImage2D(...arguments)}catch(L){nt("WebGLState:",L)}}function M(){try{t.compressedTexImage3D(...arguments)}catch(L){nt("WebGLState:",L)}}function m(){try{t.texSubImage2D(...arguments)}catch(L){nt("WebGLState:",L)}}function U(){try{t.texSubImage3D(...arguments)}catch(L){nt("WebGLState:",L)}}function F(){try{t.compressedTexSubImage2D(...arguments)}catch(L){nt("WebGLState:",L)}}function W(){try{t.compressedTexSubImage3D(...arguments)}catch(L){nt("WebGLState:",L)}}function ne(){try{t.texStorage2D(...arguments)}catch(L){nt("WebGLState:",L)}}function se(){try{t.texStorage3D(...arguments)}catch(L){nt("WebGLState:",L)}}function j(){try{t.texImage2D(...arguments)}catch(L){nt("WebGLState:",L)}}function K(){try{t.texImage3D(...arguments)}catch(L){nt("WebGLState:",L)}}function oe(L){return p[L]!==void 0?p[L]:t.getParameter(L)}function Me(L,re){p[L]!==re&&(t.pixelStorei(L,re),p[L]=re)}function de(L){it.equals(L)===!1&&(t.scissor(L.x,L.y,L.z,L.w),it.copy(L))}function le(L){ke.equals(L)===!1&&(t.viewport(L.x,L.y,L.z,L.w),ke.copy(L))}function Ee(L,re){let Z=c.get(re);Z===void 0&&(Z=new WeakMap,c.set(re,Z));let ue=Z.get(L);ue===void 0&&(ue=t.getUniformBlockIndex(re,L.name),Z.set(L,ue))}function Ce(L,re){const ue=c.get(re).get(L);l.get(re)!==ue&&(t.uniformBlockBinding(re,ue,L.__bindingPointIndex),l.set(re,ue))}function Pe(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),r.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),d={},p={},ie=null,fe={},u={},h=new WeakMap,_=[],T=null,g=!1,f=null,v=null,b=null,S=null,A=null,C=null,w=null,x=new at(0,0,0),R=0,N=!1,D=null,B=null,Y=null,ee=null,H=null,it.set(0,0,t.canvas.width,t.canvas.height),ke.set(0,0,t.canvas.width,t.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:ae,disable:Ne,bindFramebuffer:Oe,drawBuffers:we,useProgram:Tt,setBlending:$e,setMaterial:Ye,setFlipSided:Nt,setCullFace:Pt,setLineWidth:Gt,setPolygonOffset:Re,setScissorTest:At,activeTexture:Ie,bindTexture:P,unbindTexture:De,compressedTexImage2D:et,compressedTexImage3D:M,texImage2D:j,texImage3D:K,pixelStorei:Me,getParameter:oe,updateUBOMapping:Ee,uniformBlockBinding:Ce,texStorage2D:ne,texStorage3D:se,texSubImage2D:m,texSubImage3D:U,compressedTexSubImage2D:F,compressedTexSubImage3D:W,scissor:de,viewport:le,reset:Pe}}function x3(t,e,n,i,a,s,r){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ot,d=new WeakMap,p=new Set;let u;const h=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(M,m){return _?new OffscreenCanvas(M,m):Xc("canvas")}function g(M,m,U){let F=1;const W=et(M);if((W.width>U||W.height>U)&&(F=U/Math.max(W.width,W.height)),F<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){const ne=Math.floor(F*W.width),se=Math.floor(F*W.height);u===void 0&&(u=T(ne,se));const j=m?T(ne,se):u;return j.width=ne,j.height=se,j.getContext("2d").drawImage(M,0,0,ne,se),Le("WebGLRenderer: Texture has been resized from ("+W.width+"x"+W.height+") to ("+ne+"x"+se+")."),j}else return"data"in M&&Le("WebGLRenderer: Image in DataTexture is too big ("+W.width+"x"+W.height+")."),M;return M}function f(M){return M.generateMipmaps}function v(M){t.generateMipmap(M)}function b(M){return M.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?t.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function S(M,m,U,F,W,ne=!1){if(M!==null){if(t[M]!==void 0)return t[M];Le("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let se;F&&(se=e.get("EXT_texture_norm16"),se||Le("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=m;if(m===t.RED&&(U===t.FLOAT&&(j=t.R32F),U===t.HALF_FLOAT&&(j=t.R16F),U===t.UNSIGNED_BYTE&&(j=t.R8),U===t.UNSIGNED_SHORT&&se&&(j=se.R16_EXT),U===t.SHORT&&se&&(j=se.R16_SNORM_EXT)),m===t.RED_INTEGER&&(U===t.UNSIGNED_BYTE&&(j=t.R8UI),U===t.UNSIGNED_SHORT&&(j=t.R16UI),U===t.UNSIGNED_INT&&(j=t.R32UI),U===t.BYTE&&(j=t.R8I),U===t.SHORT&&(j=t.R16I),U===t.INT&&(j=t.R32I)),m===t.RG&&(U===t.FLOAT&&(j=t.RG32F),U===t.HALF_FLOAT&&(j=t.RG16F),U===t.UNSIGNED_BYTE&&(j=t.RG8),U===t.UNSIGNED_SHORT&&se&&(j=se.RG16_EXT),U===t.SHORT&&se&&(j=se.RG16_SNORM_EXT)),m===t.RG_INTEGER&&(U===t.UNSIGNED_BYTE&&(j=t.RG8UI),U===t.UNSIGNED_SHORT&&(j=t.RG16UI),U===t.UNSIGNED_INT&&(j=t.RG32UI),U===t.BYTE&&(j=t.RG8I),U===t.SHORT&&(j=t.RG16I),U===t.INT&&(j=t.RG32I)),m===t.RGB_INTEGER&&(U===t.UNSIGNED_BYTE&&(j=t.RGB8UI),U===t.UNSIGNED_SHORT&&(j=t.RGB16UI),U===t.UNSIGNED_INT&&(j=t.RGB32UI),U===t.BYTE&&(j=t.RGB8I),U===t.SHORT&&(j=t.RGB16I),U===t.INT&&(j=t.RGB32I)),m===t.RGBA_INTEGER&&(U===t.UNSIGNED_BYTE&&(j=t.RGBA8UI),U===t.UNSIGNED_SHORT&&(j=t.RGBA16UI),U===t.UNSIGNED_INT&&(j=t.RGBA32UI),U===t.BYTE&&(j=t.RGBA8I),U===t.SHORT&&(j=t.RGBA16I),U===t.INT&&(j=t.RGBA32I)),m===t.RGB&&(U===t.UNSIGNED_SHORT&&se&&(j=se.RGB16_EXT),U===t.SHORT&&se&&(j=se.RGB16_SNORM_EXT),U===t.UNSIGNED_INT_5_9_9_9_REV&&(j=t.RGB9_E5),U===t.UNSIGNED_INT_10F_11F_11F_REV&&(j=t.R11F_G11F_B10F)),m===t.RGBA){const K=ne?Vc:Ke.getTransfer(W);U===t.FLOAT&&(j=t.RGBA32F),U===t.HALF_FLOAT&&(j=t.RGBA16F),U===t.UNSIGNED_BYTE&&(j=K===ct?t.SRGB8_ALPHA8:t.RGBA8),U===t.UNSIGNED_SHORT&&se&&(j=se.RGBA16_EXT),U===t.SHORT&&se&&(j=se.RGBA16_SNORM_EXT),U===t.UNSIGNED_SHORT_4_4_4_4&&(j=t.RGBA4),U===t.UNSIGNED_SHORT_5_5_5_1&&(j=t.RGB5_A1)}return(j===t.R16F||j===t.R32F||j===t.RG16F||j===t.RG32F||j===t.RGBA16F||j===t.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function A(M,m){let U;return M?m===null||m===Ti||m===zo?U=t.DEPTH24_STENCIL8:m===Si?U=t.DEPTH32F_STENCIL8:m===Io&&(U=t.DEPTH24_STENCIL8,Le("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Ti||m===zo?U=t.DEPTH_COMPONENT24:m===Si?U=t.DEPTH_COMPONENT32F:m===Io&&(U=t.DEPTH_COMPONENT16),U}function C(M,m){return f(M)===!0||M.isFramebufferTexture&&M.minFilter!==rn&&M.minFilter!==fn?Math.log2(Math.max(m.width,m.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?m.mipmaps.length:1}function w(M){const m=M.target;m.removeEventListener("dispose",w),R(m),m.isVideoTexture&&d.delete(m),m.isHTMLTexture&&p.delete(m)}function x(M){const m=M.target;m.removeEventListener("dispose",x),D(m)}function R(M){const m=i.get(M);if(m.__webglInit===void 0)return;const U=M.source,F=h.get(U);if(F){const W=F[m.__cacheKey];W.usedTimes--,W.usedTimes===0&&N(M),Object.keys(F).length===0&&h.delete(U)}i.remove(M)}function N(M){const m=i.get(M);t.deleteTexture(m.__webglTexture);const U=M.source,F=h.get(U);delete F[m.__cacheKey],r.memory.textures--}function D(M){const m=i.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),i.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let F=0;F<6;F++){if(Array.isArray(m.__webglFramebuffer[F]))for(let W=0;W<m.__webglFramebuffer[F].length;W++)t.deleteFramebuffer(m.__webglFramebuffer[F][W]);else t.deleteFramebuffer(m.__webglFramebuffer[F]);m.__webglDepthbuffer&&t.deleteRenderbuffer(m.__webglDepthbuffer[F])}else{if(Array.isArray(m.__webglFramebuffer))for(let F=0;F<m.__webglFramebuffer.length;F++)t.deleteFramebuffer(m.__webglFramebuffer[F]);else t.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&t.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&t.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let F=0;F<m.__webglColorRenderbuffer.length;F++)m.__webglColorRenderbuffer[F]&&t.deleteRenderbuffer(m.__webglColorRenderbuffer[F]);m.__webglDepthRenderbuffer&&t.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const U=M.textures;for(let F=0,W=U.length;F<W;F++){const ne=i.get(U[F]);ne.__webglTexture&&(t.deleteTexture(ne.__webglTexture),r.memory.textures--),i.remove(U[F])}i.remove(M)}let B=0;function Y(){B=0}function ee(){return B}function H(M){B=M}function O(){const M=B;return M>=a.maxTextures&&Le("WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+a.maxTextures),B+=1,M}function I(M){const m=[];return m.push(M.wrapS),m.push(M.wrapT),m.push(M.wrapR||0),m.push(M.magFilter),m.push(M.minFilter),m.push(M.anisotropy),m.push(M.internalFormat),m.push(M.format),m.push(M.type),m.push(M.generateMipmaps),m.push(M.premultiplyAlpha),m.push(M.flipY),m.push(M.unpackAlignment),m.push(M.colorSpace),m.join()}function G(M,m){const U=i.get(M);if(M.isVideoTexture&&P(M),M.isRenderTargetTexture===!1&&M.isExternalTexture!==!0&&M.version>0&&U.__version!==M.version){const F=M.image;if(F===null)Le("WebGLRenderer: Texture marked for update but no image data found.");else if(F.complete===!1)Le("WebGLRenderer: Texture marked for update but image is incomplete");else{Ne(U,M,m);return}}else M.isExternalTexture&&(U.__webglTexture=M.sourceTexture?M.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,U.__webglTexture,t.TEXTURE0+m)}function J(M,m){const U=i.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&U.__version!==M.version){Ne(U,M,m);return}else M.isExternalTexture&&(U.__webglTexture=M.sourceTexture?M.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,U.__webglTexture,t.TEXTURE0+m)}function ie(M,m){const U=i.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&U.__version!==M.version){Ne(U,M,m);return}n.bindTexture(t.TEXTURE_3D,U.__webglTexture,t.TEXTURE0+m)}function fe(M,m){const U=i.get(M);if(M.isCubeDepthTexture!==!0&&M.version>0&&U.__version!==M.version){Oe(U,M,m);return}n.bindTexture(t.TEXTURE_CUBE_MAP,U.__webglTexture,t.TEXTURE0+m)}const ve={[Gd]:t.REPEAT,[Wi]:t.CLAMP_TO_EDGE,[Vd]:t.MIRRORED_REPEAT},We={[rn]:t.NEAREST,[Bb]:t.NEAREST_MIPMAP_NEAREST,[vl]:t.NEAREST_MIPMAP_LINEAR,[fn]:t.LINEAR,[af]:t.LINEAR_MIPMAP_NEAREST,[ss]:t.LINEAR_MIPMAP_LINEAR},it={[Gb]:t.NEVER,[qb]:t.ALWAYS,[Vb]:t.LESS,[Dp]:t.LEQUAL,[kb]:t.EQUAL,[Up]:t.GEQUAL,[Xb]:t.GREATER,[Wb]:t.NOTEQUAL};function ke(M,m){if(m.type===Si&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===fn||m.magFilter===af||m.magFilter===vl||m.magFilter===ss||m.minFilter===fn||m.minFilter===af||m.minFilter===vl||m.minFilter===ss)&&Le("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(M,t.TEXTURE_WRAP_S,ve[m.wrapS]),t.texParameteri(M,t.TEXTURE_WRAP_T,ve[m.wrapT]),(M===t.TEXTURE_3D||M===t.TEXTURE_2D_ARRAY)&&t.texParameteri(M,t.TEXTURE_WRAP_R,ve[m.wrapR]),t.texParameteri(M,t.TEXTURE_MAG_FILTER,We[m.magFilter]),t.texParameteri(M,t.TEXTURE_MIN_FILTER,We[m.minFilter]),m.compareFunction&&(t.texParameteri(M,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(M,t.TEXTURE_COMPARE_FUNC,it[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===rn||m.minFilter!==vl&&m.minFilter!==ss||m.type===Si&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){const U=e.get("EXT_texture_filter_anisotropic");t.texParameterf(M,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,a.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function Q(M,m){let U=!1;M.__webglInit===void 0&&(M.__webglInit=!0,m.addEventListener("dispose",w));const F=m.source;let W=h.get(F);W===void 0&&(W={},h.set(F,W));const ne=I(m);if(ne!==M.__cacheKey){W[ne]===void 0&&(W[ne]={texture:t.createTexture(),usedTimes:0},r.memory.textures++,U=!0),W[ne].usedTimes++;const se=W[M.__cacheKey];se!==void 0&&(W[M.__cacheKey].usedTimes--,se.usedTimes===0&&N(m)),M.__cacheKey=ne,M.__webglTexture=W[ne].texture}return U}function ce(M,m,U){return Math.floor(Math.floor(M/U)/m)}function ae(M,m,U,F){const ne=M.updateRanges;if(ne.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,m.width,m.height,U,F,m.data);else{ne.sort((Me,de)=>Me.start-de.start);let se=0;for(let Me=1;Me<ne.length;Me++){const de=ne[se],le=ne[Me],Ee=de.start+de.count,Ce=ce(le.start,m.width,4),Pe=ce(de.start,m.width,4);le.start<=Ee+1&&Ce===Pe&&ce(le.start+le.count-1,m.width,4)===Ce?de.count=Math.max(de.count,le.start+le.count-de.start):(++se,ne[se]=le)}ne.length=se+1;const j=n.getParameter(t.UNPACK_ROW_LENGTH),K=n.getParameter(t.UNPACK_SKIP_PIXELS),oe=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,m.width);for(let Me=0,de=ne.length;Me<de;Me++){const le=ne[Me],Ee=Math.floor(le.start/4),Ce=Math.ceil(le.count/4),Pe=Ee%m.width,L=Math.floor(Ee/m.width),re=Ce,Z=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Pe),n.pixelStorei(t.UNPACK_SKIP_ROWS,L),n.texSubImage2D(t.TEXTURE_2D,0,Pe,L,re,Z,U,F,m.data)}M.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,j),n.pixelStorei(t.UNPACK_SKIP_PIXELS,K),n.pixelStorei(t.UNPACK_SKIP_ROWS,oe)}}function Ne(M,m,U){let F=t.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(F=t.TEXTURE_2D_ARRAY),m.isData3DTexture&&(F=t.TEXTURE_3D);const W=Q(M,m),ne=m.source;n.bindTexture(F,M.__webglTexture,t.TEXTURE0+U);const se=i.get(ne);if(ne.version!==se.__version||W===!0){if(n.activeTexture(t.TEXTURE0+U),(typeof ImageBitmap<"u"&&m.image instanceof ImageBitmap)===!1){const Z=Ke.getPrimaries(Ke.workingColorSpace),ue=m.colorSpace===ba?null:Ke.getPrimaries(m.colorSpace),he=m.colorSpace===ba||Z===ue?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,he)}n.pixelStorei(t.UNPACK_ALIGNMENT,m.unpackAlignment);let K=g(m.image,!1,a.maxTextureSize);K=De(m,K);const oe=s.convert(m.format,m.colorSpace),Me=s.convert(m.type);let de=S(m.internalFormat,oe,Me,m.normalized,m.colorSpace,m.isVideoTexture);ke(F,m);let le;const Ee=m.mipmaps,Ce=m.isVideoTexture!==!0,Pe=se.__version===void 0||W===!0,L=ne.dataReady,re=C(m,K);if(m.isDepthTexture)de=A(m.format===rs,m.type),Pe&&(Ce?n.texStorage2D(t.TEXTURE_2D,1,de,K.width,K.height):n.texImage2D(t.TEXTURE_2D,0,de,K.width,K.height,0,oe,Me,null));else if(m.isDataTexture)if(Ee.length>0){Ce&&Pe&&n.texStorage2D(t.TEXTURE_2D,re,de,Ee[0].width,Ee[0].height);for(let Z=0,ue=Ee.length;Z<ue;Z++)le=Ee[Z],Ce?L&&n.texSubImage2D(t.TEXTURE_2D,Z,0,0,le.width,le.height,oe,Me,le.data):n.texImage2D(t.TEXTURE_2D,Z,de,le.width,le.height,0,oe,Me,le.data);m.generateMipmaps=!1}else Ce?(Pe&&n.texStorage2D(t.TEXTURE_2D,re,de,K.width,K.height),L&&ae(m,K,oe,Me)):n.texImage2D(t.TEXTURE_2D,0,de,K.width,K.height,0,oe,Me,K.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){Ce&&Pe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,re,de,Ee[0].width,Ee[0].height,K.depth);for(let Z=0,ue=Ee.length;Z<ue;Z++)if(le=Ee[Z],m.format!==oi)if(oe!==null)if(Ce){if(L)if(m.layerUpdates.size>0){const he=Q0(le.width,le.height,m.format,m.type);for(const te of m.layerUpdates){const ye=le.data.subarray(te*he/le.data.BYTES_PER_ELEMENT,(te+1)*he/le.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Z,0,0,te,le.width,le.height,1,oe,ye)}m.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Z,0,0,0,le.width,le.height,K.depth,oe,le.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,Z,de,le.width,le.height,K.depth,0,le.data,0,0);else Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ce?L&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,Z,0,0,0,le.width,le.height,K.depth,oe,Me,le.data):n.texImage3D(t.TEXTURE_2D_ARRAY,Z,de,le.width,le.height,K.depth,0,oe,Me,le.data)}else{Ce&&Pe&&n.texStorage2D(t.TEXTURE_2D,re,de,Ee[0].width,Ee[0].height);for(let Z=0,ue=Ee.length;Z<ue;Z++)le=Ee[Z],m.format!==oi?oe!==null?Ce?L&&n.compressedTexSubImage2D(t.TEXTURE_2D,Z,0,0,le.width,le.height,oe,le.data):n.compressedTexImage2D(t.TEXTURE_2D,Z,de,le.width,le.height,0,le.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ce?L&&n.texSubImage2D(t.TEXTURE_2D,Z,0,0,le.width,le.height,oe,Me,le.data):n.texImage2D(t.TEXTURE_2D,Z,de,le.width,le.height,0,oe,Me,le.data)}else if(m.isDataArrayTexture)if(Ce){if(Pe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,re,de,K.width,K.height,K.depth),L)if(m.layerUpdates.size>0){const Z=Q0(K.width,K.height,m.format,m.type);for(const ue of m.layerUpdates){const he=K.data.subarray(ue*Z/K.data.BYTES_PER_ELEMENT,(ue+1)*Z/K.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,ue,K.width,K.height,1,oe,Me,he)}m.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,oe,Me,K.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,de,K.width,K.height,K.depth,0,oe,Me,K.data);else if(m.isData3DTexture)Ce?(Pe&&n.texStorage3D(t.TEXTURE_3D,re,de,K.width,K.height,K.depth),L&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,oe,Me,K.data)):n.texImage3D(t.TEXTURE_3D,0,de,K.width,K.height,K.depth,0,oe,Me,K.data);else if(m.isFramebufferTexture){if(Pe)if(Ce)n.texStorage2D(t.TEXTURE_2D,re,de,K.width,K.height);else{let Z=K.width,ue=K.height;for(let he=0;he<re;he++)n.texImage2D(t.TEXTURE_2D,he,de,Z,ue,0,oe,Me,null),Z>>=1,ue>>=1}}else if(m.isHTMLTexture){if("texElementImage2D"in t){const Z=t.canvas;if(Z.hasAttribute("layoutsubtree")||Z.setAttribute("layoutsubtree","true"),K.parentNode!==Z){Z.appendChild(K),p.add(m),Z.onpaint=ue=>{const he=ue.changedElements;for(const te of p)he.includes(te.image)&&(te.needsUpdate=!0)},Z.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,K);else{const he=t.RGBA,te=t.RGBA,ye=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,he,te,ye,K)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Ee.length>0){if(Ce&&Pe){const Z=et(Ee[0]);n.texStorage2D(t.TEXTURE_2D,re,de,Z.width,Z.height)}for(let Z=0,ue=Ee.length;Z<ue;Z++)le=Ee[Z],Ce?L&&n.texSubImage2D(t.TEXTURE_2D,Z,0,0,oe,Me,le):n.texImage2D(t.TEXTURE_2D,Z,de,oe,Me,le);m.generateMipmaps=!1}else if(Ce){if(Pe){const Z=et(K);n.texStorage2D(t.TEXTURE_2D,re,de,Z.width,Z.height)}L&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,oe,Me,K)}else n.texImage2D(t.TEXTURE_2D,0,de,oe,Me,K);f(m)&&v(F),se.__version=ne.version,m.onUpdate&&m.onUpdate(m)}M.__version=m.version}function Oe(M,m,U){if(m.image.length!==6)return;const F=Q(M,m),W=m.source;n.bindTexture(t.TEXTURE_CUBE_MAP,M.__webglTexture,t.TEXTURE0+U);const ne=i.get(W);if(W.version!==ne.__version||F===!0){n.activeTexture(t.TEXTURE0+U);const se=Ke.getPrimaries(Ke.workingColorSpace),j=m.colorSpace===ba?null:Ke.getPrimaries(m.colorSpace),K=m.colorSpace===ba||se===j?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);const oe=m.isCompressedTexture||m.image[0].isCompressedTexture,Me=m.image[0]&&m.image[0].isDataTexture,de=[];for(let te=0;te<6;te++)!oe&&!Me?de[te]=g(m.image[te],!0,a.maxCubemapSize):de[te]=Me?m.image[te].image:m.image[te],de[te]=De(m,de[te]);const le=de[0],Ee=s.convert(m.format,m.colorSpace),Ce=s.convert(m.type),Pe=S(m.internalFormat,Ee,Ce,m.normalized,m.colorSpace),L=m.isVideoTexture!==!0,re=ne.__version===void 0||F===!0,Z=W.dataReady;let ue=C(m,le);ke(t.TEXTURE_CUBE_MAP,m);let he;if(oe){L&&re&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ue,Pe,le.width,le.height);for(let te=0;te<6;te++){he=de[te].mipmaps;for(let ye=0;ye<he.length;ye++){const me=he[ye];m.format!==oi?Ee!==null?L?Z&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,ye,0,0,me.width,me.height,Ee,me.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,ye,Pe,me.width,me.height,0,me.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?Z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,ye,0,0,me.width,me.height,Ee,Ce,me.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,ye,Pe,me.width,me.height,0,Ee,Ce,me.data)}}}else{if(he=m.mipmaps,L&&re){he.length>0&&ue++;const te=et(de[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ue,Pe,te.width,te.height)}for(let te=0;te<6;te++)if(Me){L?Z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,de[te].width,de[te].height,Ee,Ce,de[te].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Pe,de[te].width,de[te].height,0,Ee,Ce,de[te].data);for(let ye=0;ye<he.length;ye++){const Rt=he[ye].image[te].image;L?Z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,ye+1,0,0,Rt.width,Rt.height,Ee,Ce,Rt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,ye+1,Pe,Rt.width,Rt.height,0,Ee,Ce,Rt.data)}}else{L?Z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,Ee,Ce,de[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Pe,Ee,Ce,de[te]);for(let ye=0;ye<he.length;ye++){const me=he[ye];L?Z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,ye+1,0,0,Ee,Ce,me.image[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,ye+1,Pe,Ee,Ce,me.image[te])}}}f(m)&&v(t.TEXTURE_CUBE_MAP),ne.__version=W.version,m.onUpdate&&m.onUpdate(m)}M.__version=m.version}function we(M,m,U,F,W,ne){const se=s.convert(U.format,U.colorSpace),j=s.convert(U.type),K=S(U.internalFormat,se,j,U.normalized,U.colorSpace),oe=i.get(m),Me=i.get(U);if(Me.__renderTarget=m,!oe.__hasExternalTextures){const de=Math.max(1,m.width>>ne),le=Math.max(1,m.height>>ne);W===t.TEXTURE_3D||W===t.TEXTURE_2D_ARRAY?n.texImage3D(W,ne,K,de,le,m.depth,0,se,j,null):n.texImage2D(W,ne,K,de,le,0,se,j,null)}n.bindFramebuffer(t.FRAMEBUFFER,M),Ie(m)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,F,W,Me.__webglTexture,0,At(m)):(W===t.TEXTURE_2D||W>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&W<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,F,W,Me.__webglTexture,ne),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Tt(M,m,U){if(t.bindRenderbuffer(t.RENDERBUFFER,M),m.depthBuffer){const F=m.depthTexture,W=F&&F.isDepthTexture?F.type:null,ne=A(m.stencilBuffer,W),se=m.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Ie(m)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,At(m),ne,m.width,m.height):U?t.renderbufferStorageMultisample(t.RENDERBUFFER,At(m),ne,m.width,m.height):t.renderbufferStorage(t.RENDERBUFFER,ne,m.width,m.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,se,t.RENDERBUFFER,M)}else{const F=m.textures;for(let W=0;W<F.length;W++){const ne=F[W],se=s.convert(ne.format,ne.colorSpace),j=s.convert(ne.type),K=S(ne.internalFormat,se,j,ne.normalized,ne.colorSpace);Ie(m)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,At(m),K,m.width,m.height):U?t.renderbufferStorageMultisample(t.RENDERBUFFER,At(m),K,m.width,m.height):t.renderbufferStorage(t.RENDERBUFFER,K,m.width,m.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Xe(M,m,U){const F=m.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,M),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const W=i.get(m.depthTexture);if(W.__renderTarget=m,(!W.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),F){if(W.__webglInit===void 0&&(W.__webglInit=!0,m.depthTexture.addEventListener("dispose",w)),W.__webglTexture===void 0){W.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,W.__webglTexture),ke(t.TEXTURE_CUBE_MAP,m.depthTexture);const oe=s.convert(m.depthTexture.format),Me=s.convert(m.depthTexture.type);let de;m.depthTexture.format===aa?de=t.DEPTH_COMPONENT24:m.depthTexture.format===rs&&(de=t.DEPTH24_STENCIL8);for(let le=0;le<6;le++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,de,m.width,m.height,0,oe,Me,null)}}else G(m.depthTexture,0);const ne=W.__webglTexture,se=At(m),j=F?t.TEXTURE_CUBE_MAP_POSITIVE_X+U:t.TEXTURE_2D,K=m.depthTexture.format===rs?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(m.depthTexture.format===aa)Ie(m)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,K,j,ne,0,se):t.framebufferTexture2D(t.FRAMEBUFFER,K,j,ne,0);else if(m.depthTexture.format===rs)Ie(m)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,K,j,ne,0,se):t.framebufferTexture2D(t.FRAMEBUFFER,K,j,ne,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function lt(M){const m=i.get(M),U=M.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==M.depthTexture){const F=M.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),F){const W=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,F.removeEventListener("dispose",W)};F.addEventListener("dispose",W),m.__depthDisposeCallback=W}m.__boundDepthTexture=F}if(M.depthTexture&&!m.__autoAllocateDepthBuffer)if(U)for(let F=0;F<6;F++)Xe(m.__webglFramebuffer[F],M,F);else{const F=M.texture.mipmaps;F&&F.length>0?Xe(m.__webglFramebuffer[0],M,0):Xe(m.__webglFramebuffer,M,0)}else if(U){m.__webglDepthbuffer=[];for(let F=0;F<6;F++)if(n.bindFramebuffer(t.FRAMEBUFFER,m.__webglFramebuffer[F]),m.__webglDepthbuffer[F]===void 0)m.__webglDepthbuffer[F]=t.createRenderbuffer(),Tt(m.__webglDepthbuffer[F],M,!1);else{const W=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ne=m.__webglDepthbuffer[F];t.bindRenderbuffer(t.RENDERBUFFER,ne),t.framebufferRenderbuffer(t.FRAMEBUFFER,W,t.RENDERBUFFER,ne)}}else{const F=M.texture.mipmaps;if(F&&F.length>0?n.bindFramebuffer(t.FRAMEBUFFER,m.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=t.createRenderbuffer(),Tt(m.__webglDepthbuffer,M,!1);else{const W=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ne=m.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ne),t.framebufferRenderbuffer(t.FRAMEBUFFER,W,t.RENDERBUFFER,ne)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function $e(M,m,U){const F=i.get(M);m!==void 0&&we(F.__webglFramebuffer,M,M.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),U!==void 0&&lt(M)}function Ye(M){const m=M.texture,U=i.get(M),F=i.get(m);M.addEventListener("dispose",x);const W=M.textures,ne=M.isWebGLCubeRenderTarget===!0,se=W.length>1;if(se||(F.__webglTexture===void 0&&(F.__webglTexture=t.createTexture()),F.__version=m.version,r.memory.textures++),ne){U.__webglFramebuffer=[];for(let j=0;j<6;j++)if(m.mipmaps&&m.mipmaps.length>0){U.__webglFramebuffer[j]=[];for(let K=0;K<m.mipmaps.length;K++)U.__webglFramebuffer[j][K]=t.createFramebuffer()}else U.__webglFramebuffer[j]=t.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){U.__webglFramebuffer=[];for(let j=0;j<m.mipmaps.length;j++)U.__webglFramebuffer[j]=t.createFramebuffer()}else U.__webglFramebuffer=t.createFramebuffer();if(se)for(let j=0,K=W.length;j<K;j++){const oe=i.get(W[j]);oe.__webglTexture===void 0&&(oe.__webglTexture=t.createTexture(),r.memory.textures++)}if(M.samples>0&&Ie(M)===!1){U.__webglMultisampledFramebuffer=t.createFramebuffer(),U.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let j=0;j<W.length;j++){const K=W[j];U.__webglColorRenderbuffer[j]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,U.__webglColorRenderbuffer[j]);const oe=s.convert(K.format,K.colorSpace),Me=s.convert(K.type),de=S(K.internalFormat,oe,Me,K.normalized,K.colorSpace,M.isXRRenderTarget===!0),le=At(M);t.renderbufferStorageMultisample(t.RENDERBUFFER,le,de,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+j,t.RENDERBUFFER,U.__webglColorRenderbuffer[j])}t.bindRenderbuffer(t.RENDERBUFFER,null),M.depthBuffer&&(U.__webglDepthRenderbuffer=t.createRenderbuffer(),Tt(U.__webglDepthRenderbuffer,M,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ne){n.bindTexture(t.TEXTURE_CUBE_MAP,F.__webglTexture),ke(t.TEXTURE_CUBE_MAP,m);for(let j=0;j<6;j++)if(m.mipmaps&&m.mipmaps.length>0)for(let K=0;K<m.mipmaps.length;K++)we(U.__webglFramebuffer[j][K],M,m,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+j,K);else we(U.__webglFramebuffer[j],M,m,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);f(m)&&v(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(se){for(let j=0,K=W.length;j<K;j++){const oe=W[j],Me=i.get(oe);let de=t.TEXTURE_2D;(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(de=M.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(de,Me.__webglTexture),ke(de,oe),we(U.__webglFramebuffer,M,oe,t.COLOR_ATTACHMENT0+j,de,0),f(oe)&&v(de)}n.unbindTexture()}else{let j=t.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(j=M.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(j,F.__webglTexture),ke(j,m),m.mipmaps&&m.mipmaps.length>0)for(let K=0;K<m.mipmaps.length;K++)we(U.__webglFramebuffer[K],M,m,t.COLOR_ATTACHMENT0,j,K);else we(U.__webglFramebuffer,M,m,t.COLOR_ATTACHMENT0,j,0);f(m)&&v(j),n.unbindTexture()}M.depthBuffer&&lt(M)}function Nt(M){const m=M.textures;for(let U=0,F=m.length;U<F;U++){const W=m[U];if(f(W)){const ne=b(M),se=i.get(W).__webglTexture;n.bindTexture(ne,se),v(ne),n.unbindTexture()}}}const Pt=[],Gt=[];function Re(M){if(M.samples>0){if(Ie(M)===!1){const m=M.textures,U=M.width,F=M.height;let W=t.COLOR_BUFFER_BIT;const ne=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,se=i.get(M),j=m.length>1;if(j)for(let oe=0;oe<m.length;oe++)n.bindFramebuffer(t.FRAMEBUFFER,se.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+oe,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,se.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+oe,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,se.__webglMultisampledFramebuffer);const K=M.texture.mipmaps;K&&K.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,se.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,se.__webglFramebuffer);for(let oe=0;oe<m.length;oe++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(W|=t.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(W|=t.STENCIL_BUFFER_BIT)),j){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,se.__webglColorRenderbuffer[oe]);const Me=i.get(m[oe]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Me,0)}t.blitFramebuffer(0,0,U,F,0,0,U,F,W,t.NEAREST),l===!0&&(Pt.length=0,Gt.length=0,Pt.push(t.COLOR_ATTACHMENT0+oe),M.depthBuffer&&M.resolveDepthBuffer===!1&&(Pt.push(ne),Gt.push(ne),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Gt)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,Pt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),j)for(let oe=0;oe<m.length;oe++){n.bindFramebuffer(t.FRAMEBUFFER,se.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+oe,t.RENDERBUFFER,se.__webglColorRenderbuffer[oe]);const Me=i.get(m[oe]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,se.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+oe,t.TEXTURE_2D,Me,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,se.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&l){const m=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[m])}}}function At(M){return Math.min(a.maxSamples,M.samples)}function Ie(M){const m=i.get(M);return M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function P(M){const m=r.render.frame;d.get(M)!==m&&(d.set(M,m),M.update())}function De(M,m){const U=M.colorSpace,F=M.format,W=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||U!==Gc&&U!==ba&&(Ke.getTransfer(U)===ct?(F!==oi||W!==Qn)&&Le("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):nt("WebGLTextures: Unsupported texture color space:",U)),m}function et(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(c.width=M.naturalWidth||M.width,c.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(c.width=M.displayWidth,c.height=M.displayHeight):(c.width=M.width,c.height=M.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=Y,this.getTextureUnits=ee,this.setTextureUnits=H,this.setTexture2D=G,this.setTexture2DArray=J,this.setTexture3D=ie,this.setTextureCube=fe,this.rebindTextures=$e,this.setupRenderTarget=Ye,this.updateRenderTargetMipmap=Nt,this.updateMultisampleRenderTarget=Re,this.setupDepthRenderbuffer=lt,this.setupFrameBufferTexture=we,this.useMultisampledRTT=Ie,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function v3(t,e){function n(i,a=ba){let s;const r=Ke.getTransfer(a);if(i===Qn)return t.UNSIGNED_BYTE;if(i===Ap)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Rp)return t.UNSIGNED_SHORT_5_5_5_1;if(i===P_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===I_)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===L_)return t.BYTE;if(i===O_)return t.SHORT;if(i===Io)return t.UNSIGNED_SHORT;if(i===Tp)return t.INT;if(i===Ti)return t.UNSIGNED_INT;if(i===Si)return t.FLOAT;if(i===ia)return t.HALF_FLOAT;if(i===z_)return t.ALPHA;if(i===B_)return t.RGB;if(i===oi)return t.RGBA;if(i===aa)return t.DEPTH_COMPONENT;if(i===rs)return t.DEPTH_STENCIL;if(i===F_)return t.RED;if(i===Cp)return t.RED_INTEGER;if(i===vs)return t.RG;if(i===wp)return t.RG_INTEGER;if(i===Np)return t.RGBA_INTEGER;if(i===sc||i===rc||i===oc||i===lc)if(r===ct)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===sc)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===rc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===oc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===lc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===sc)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===rc)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===oc)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===lc)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===kd||i===Xd||i===Wd||i===qd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===kd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Xd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Wd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===qd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===jd||i===Yd||i===Zd||i===Kd||i===Qd||i===Fc||i===Jd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===jd||i===Yd)return r===ct?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Zd)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Kd)return s.COMPRESSED_R11_EAC;if(i===Qd)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Fc)return s.COMPRESSED_RG11_EAC;if(i===Jd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===$d||i===eh||i===th||i===nh||i===ih||i===ah||i===sh||i===rh||i===oh||i===lh||i===ch||i===uh||i===fh||i===dh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===$d)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===eh)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===th)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===nh)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===ih)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ah)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===sh)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===rh)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===oh)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===lh)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ch)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===uh)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===fh)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===dh)return r===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===hh||i===ph||i===mh)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===hh)return r===ct?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ph)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===mh)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===gh||i===xh||i===Hc||i===vh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===gh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===xh)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Hc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===vh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===zo?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const _3=`
void main() {
