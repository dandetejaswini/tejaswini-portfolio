 ...
 */var gS=Symbol.for("react.transitional.element"),xS=Symbol.for("react.fragment");function bg(t,e,n){var i=null;if(n!==void 0&&(i=""+n),e.key!==void 0&&(i=""+e.key),"key"in e){n={};for(var a in e)a!=="key"&&(n[a]=e[a])}else n=e;return e=n.ref,{$$typeof:gS,type:t,key:i,ref:e!==void 0?e:null,props:n}}qc.Fragment=xS;qc.jsx=bg;qc.jsxs=bg;Mg.exports=qc;var y=Mg.exports,Eg={exports:{}},ze={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
}`,h3=[new k(1,0,0),new k(-1,0,0),new k(0,1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1)],p3=[new k(0,-1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1),new k(0,-1,0),new k(0,-1,0)],Sg=new Ht,$r=new k,Of=new k;function m3(t,e,n){let i=new Y_;const a=new ct,s=new ct,r=new Pt,l=new w1,o=new N1,c={},d=n.maxTextureSize,p={[ka]:bn,[bn]:ka,[Gi]:Gi},u=new Ai({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ct},radius:{value:4}},vertexShader:f3,fragmentShader:d3}),h=u.clone();h.defines.HORIZONTAL_PASS=1;const _=new ui;_.setAttribute("position",new oi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new sa(_,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ac;let f=this.type;this.render=function(R,C,v){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;this.type===xb&&(Oe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ac);const A=t.getRenderTarget(),N=t.getActiveCubeFace(),D=t.getActiveMipmapLevel(),B=t.state;B.setBlending(Zi),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const Y=f!==this.type;Y&&C.traverse(function(te){te.material&&(Array.isArray(te.material)?te.material.forEach(F=>F.needsUpdate=!0):te.material.needsUpdate=!0)});for(let te=0,F=R.length;te<F;te++){const U=R[te],P=U.shadow;if(P===void 0){Oe("WebGLShadowMap:",U,"has no shadow.");continue}if(P.autoUpdate===!1&&P.needsUpdate===!1)continue;a.copy(P.mapSize);const X=P.getFrameExtents();a.multiply(X),s.copy(P.mapSize),(a.x>d||a.y>d)&&(a.x>d&&(s.x=Math.floor(d/X.x),a.x=s.x*X.x,P.mapSize.x=s.x),a.y>d&&(s.y=Math.floor(d/X.y),a.y=s.y*X.y,P.mapSize.y=s.y));const J=t.state.buffers.depth.getReversed();if(P.camera._reversedDepth=J,P.map===null||Y===!0){if(P.map!==null&&(P.map.depthTexture!==null&&(P.map.depthTexture.dispose(),P.map.depthTexture=null),P.map.dispose()),this.type===sl){if(U.isPointLight){Oe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}P.map=new Ei(a.x,a.y,{format:vs,type:ia,minFilter:fn,magFilter:fn,generateMipmaps:!1}),P.map.texture.name=U.name+".shadowMap",P.map.depthTexture=new Cr(a.x,a.y,Si),P.map.depthTexture.name=U.name+".shadowMapDepth",P.map.depthTexture.format=aa,P.map.depthTexture.compareFunction=null,P.map.depthTexture.minFilter=rn,P.map.depthTexture.magFilter=rn}else U.isPointLight?(P.map=new iS(a.x),P.map.depthTexture=new b1(a.x,Ti)):(P.map=new Ei(a.x,a.y),P.map.depthTexture=new Cr(a.x,a.y,Ti)),P.map.depthTexture.name=U.name+".shadowMap",P.map.depthTexture.format=aa,this.type===ac?(P.map.depthTexture.compareFunction=J?Up:Dp,P.map.depthTexture.minFilter=fn,P.map.depthTexture.magFilter=fn):(P.map.depthTexture.compareFunction=null,P.map.depthTexture.minFilter=rn,P.map.depthTexture.magFilter=rn);P.camera.updateProjectionMatrix()}const ie=P.map.isWebGLCubeRenderTarget?6:1;for(let fe=0;fe<ie;fe++){if(P.map.isWebGLCubeRenderTarget)t.setRenderTarget(P.map,fe),t.clear();else{fe===0&&(t.setRenderTarget(P.map),t.clear());const Se=P.getViewport(fe);r.set(s.x*Se.x,s.y*Se.y,s.x*Se.z,s.y*Se.w),B.viewport(r)}if(U.isPointLight){const Se=P.camera,Xe=P.matrix,$e=U.distance||Se.far;$e!==Se.far&&(Se.far=$e,Se.updateProjectionMatrix()),$r.setFromMatrixPosition(U.matrixWorld),Se.position.copy($r),Of.copy(Se.position),Of.add(h3[fe]),Se.up.copy(p3[fe]),Se.lookAt(Of),Se.updateMatrixWorld(),Xe.makeTranslation(-$r.x,-$r.y,-$r.z),Sg.multiplyMatrices(Se.projectionMatrix,Se.matrixWorldInverse),P._frustum.setFromProjectionMatrix(Sg,Se.coordinateSystem,Se.reversedDepth)}else P.updateMatrices(U);i=P.getFrustum(),S(C,v,P.camera,U,this.type)}P.isPointLightShadow!==!0&&this.type===sl&&x(P,v),P.needsUpdate=!1}f=this.type,m.needsUpdate=!1,t.setRenderTarget(A,N,D)};function x(R,C){const v=e.update(E);u.defines.VSM_SAMPLES!==R.blurSamples&&(u.defines.VSM_SAMPLES=R.blurSamples,h.defines.VSM_SAMPLES=R.blurSamples,u.needsUpdate=!0,h.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Ei(a.x,a.y,{format:vs,type:ia})),u.uniforms.shadow_pass.value=R.map.depthTexture,u.uniforms.resolution.value=R.mapSize,u.uniforms.radius.value=R.radius,t.setRenderTarget(R.mapPass),t.clear(),t.renderBufferDirect(C,null,v,u,E,null),h.uniforms.shadow_pass.value=R.mapPass.texture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,t.setRenderTarget(R.map),t.clear(),t.renderBufferDirect(C,null,v,h,E,null)}function M(R,C,v,A){let N=null;const D=v.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(D!==void 0)N=D;else if(N=v.isPointLight===!0?o:l,t.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const B=N.uuid,Y=C.uuid;let te=c[B];te===void 0&&(te={},c[B]=te);let F=te[Y];F===void 0&&(F=N.clone(),te[Y]=F,C.addEventListener("dispose",T)),N=F}if(N.visible=C.visible,N.wireframe=C.wireframe,A===sl?N.side=C.shadowSide!==null?C.shadowSide:C.side:N.side=C.shadowSide!==null?C.shadowSide:p[C.side],N.alphaMap=C.alphaMap,N.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,N.map=C.map,N.clipShadows=C.clipShadows,N.clippingPlanes=C.clippingPlanes,N.clipIntersection=C.clipIntersection,N.displacementMap=C.displacementMap,N.displacementScale=C.displacementScale,N.displacementBias=C.displacementBias,N.wireframeLinewidth=C.wireframeLinewidth,N.linewidth=C.linewidth,v.isPointLight===!0&&N.isMeshDistanceMaterial===!0){const B=t.properties.get(N);B.light=v}return N}function S(R,C,v,A,N){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&N===sl)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,R.matrixWorld);const Y=e.update(R),te=R.material;if(Array.isArray(te)){const F=Y.groups;for(let U=0,P=F.length;U<P;U++){const X=F[U],J=te[X.materialIndex];if(J&&J.visible){const ie=M(R,J,A,N);R.onBeforeShadow(t,R,C,v,Y,ie,X),t.renderBufferDirect(v,null,Y,ie,R,X),R.onAfterShadow(t,R,C,v,Y,ie,X)}}}else if(te.visible){const F=M(R,te,A,N);R.onBeforeShadow(t,R,C,v,Y,F,null),t.renderBufferDirect(v,null,Y,F,R,null),R.onAfterShadow(t,R,C,v,Y,F,null)}}const B=R.children;for(let Y=0,te=B.length;Y<te;Y++)S(B[Y],C,v,A,N)}function T(R){R.target.removeEventListener("dispose",T);for(const v in c){const A=c[v],N=R.target.uuid;N in A&&(A[N].dispose(),delete A[N])}}}function g3(t,e){function n(){let L=!1;const de=new Pt;let Q=null;const pe=new Pt(0,0,0,0);return{setMask:function(_e){Q!==_e&&!L&&(t.colorMask(_e,_e,_e,_e),Q=_e)},setLocked:function(_e){L=_e},setClear:function(_e,ne,Ce,Te,Nt){Nt===!0&&(_e*=Te,ne*=Te,Ce*=Te),de.set(_e,ne,Ce,Te),pe.equals(de)===!1&&(t.clearColor(_e,ne,Ce,Te),pe.copy(de))},reset:function(){L=!1,Q=null,pe.set(-1,0,0,0)}}}function i(){let L=!1,de=!1,Q=null,pe=null,_e=null;return{setReversed:function(ne){if(de!==ne){const Ce=e.get("EXT_clip_control");ne?Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.ZERO_TO_ONE_EXT):Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.NEGATIVE_ONE_TO_ONE_EXT),de=ne;const Te=_e;_e=null,this.setClear(Te)}},getReversed:function(){return de},setTest:function(ne){ne?ae(t.DEPTH_TEST):le(t.DEPTH_TEST)},setMask:function(ne){Q!==ne&&!L&&(t.depthMask(ne),Q=ne)},setFunc:function(ne){if(de&&(ne=Kb[ne]),pe!==ne){switch(ne){case Od:t.depthFunc(t.NEVER);break;case Pd:t.depthFunc(t.ALWAYS);break;case Id:t.depthFunc(t.LESS);break;case Ar:t.depthFunc(t.LEQUAL);break;case zd:t.depthFunc(t.EQUAL);break;case Bd:t.depthFunc(t.GEQUAL);break;case Fd:t.depthFunc(t.GREATER);break;case Hd:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}pe=ne}},setLocked:function(ne){L=ne},setClear:function(ne){_e!==ne&&(_e=ne,de&&(ne=1-ne),t.clearDepth(ne))},reset:function(){L=!1,Q=null,pe=null,_e=null,de=!1}}}function a(){let L=!1,de=null,Q=null,pe=null,_e=null,ne=null,Ce=null,Te=null,Nt=null;return{setTest:function(St){L||(St?ae(t.STENCIL_TEST):le(t.STENCIL_TEST))},setMask:function(St){de!==St&&!L&&(t.stencilMask(St),de=St)},setFunc:function(St,fi,di){(Q!==St||pe!==fi||_e!==di)&&(t.stencilFunc(St,fi,di),Q=St,pe=fi,_e=di)},setOp:function(St,fi,di){(ne!==St||Ce!==fi||Te!==di)&&(t.stencilOp(St,fi,di),ne=St,Ce=fi,Te=di)},setLocked:function(St){L=St},setClear:function(St){Nt!==St&&(t.clearStencil(St),Nt=St)},reset:function(){L=!1,de=null,Q=null,pe=null,_e=null,ne=null,Ce=null,Te=null,Nt=null}}}const s=new n,r=new i,l=new a,o=new WeakMap,c=new WeakMap;let d={},p={},u={},h=new WeakMap,_=[],E=null,m=!1,f=null,x=null,M=null,S=null,T=null,R=null,C=null,v=new rt(0,0,0),A=0,N=!1,D=null,B=null,Y=null,te=null,F=null;const U=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let P=!1,X=0;const J=t.getParameter(t.VERSION);J.indexOf("WebGL")!==-1?(X=parseFloat(/^WebGL (\d)/.exec(J)[1]),P=X>=1):J.indexOf("OpenGL ES")!==-1&&(X=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),P=X>=2);let ie=null,fe={};const Se=t.getParameter(t.SCISSOR_BOX),Xe=t.getParameter(t.VIEWPORT),$e=new Pt().fromArray(Se),Ve=new Pt().fromArray(Xe);function K(L,de,Q,pe){const _e=new Uint8Array(4),ne=t.createTexture();t.bindTexture(L,ne),t.texParameteri(L,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(L,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ce=0;Ce<Q;Ce++)L===t.TEXTURE_3D||L===t.TEXTURE_2D_ARRAY?t.texImage3D(de,0,t.RGBA,1,1,pe,0,t.RGBA,t.UNSIGNED_BYTE,_e):t.texImage2D(de+Ce,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,_e);return ne}const ce={};ce[t.TEXTURE_2D]=K(t.TEXTURE_2D,t.TEXTURE_2D,1),ce[t.TEXTURE_CUBE_MAP]=K(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ce[t.TEXTURE_2D_ARRAY]=K(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ce[t.TEXTURE_3D]=K(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),l.setClear(0),ae(t.DEPTH_TEST),r.setFunc(Ar),Je(!1),nt(M0),ae(t.CULL_FACE),ee(Zi);function ae(L){d[L]!==!0&&(t.enable(L),d[L]=!0)}function le(L){d[L]!==!1&&(t.disable(L),d[L]=!1)}function Pe(L,de){return u[L]!==de?(t.bindFramebuffer(L,de),u[L]=de,L===t.DRAW_FRAMEBUFFER&&(u[t.FRAMEBUFFER]=de),L===t.FRAMEBUFFER&&(u[t.DRAW_FRAMEBUFFER]=de),!0):!1}function xe(L,de){let Q=_,pe=!1;if(L){Q=h.get(de),Q===void 0&&(Q=[],h.set(de,Q));const _e=L.textures;if(Q.length!==_e.length||Q[0]!==t.COLOR_ATTACHMENT0){for(let ne=0,Ce=_e.length;ne<Ce;ne++)Q[ne]=t.COLOR_ATTACHMENT0+ne;Q.length=_e.length,pe=!0}}else Q[0]!==t.BACK&&(Q[0]=t.BACK,pe=!0);pe&&t.drawBuffers(Q)}function Ct(L){return E!==L?(t.useProgram(L),E=L,!0):!1}const be={[is]:t.FUNC_ADD,[_b]:t.FUNC_SUBTRACT,[Sb]:t.FUNC_REVERSE_SUBTRACT};be[yb]=t.MIN,be[Mb]=t.MAX;const at={[bb]:t.ZERO,[Eb]:t.ONE,[Tb]:t.SRC_COLOR,[Ud]:t.SRC_ALPHA,[Db]:t.SRC_ALPHA_SATURATE,[wb]:t.DST_COLOR,[Rb]:t.DST_ALPHA,[Ab]:t.ONE_MINUS_SRC_COLOR,[Ld]:t.ONE_MINUS_SRC_ALPHA,[Nb]:t.ONE_MINUS_DST_COLOR,[Cb]:t.ONE_MINUS_DST_ALPHA,[Ub]:t.CONSTANT_COLOR,[Lb]:t.ONE_MINUS_CONSTANT_COLOR,[Ob]:t.CONSTANT_ALPHA,[Pb]:t.ONE_MINUS_CONSTANT_ALPHA};function ee(L,de,Q,pe,_e,ne,Ce,Te,Nt,St){if(L===Zi){m===!0&&(le(t.BLEND),m=!1);return}if(m===!1&&(ae(t.BLEND),m=!0),L!==vb){if(L!==f||St!==N){if((x!==is||T!==is)&&(t.blendEquation(t.FUNC_ADD),x=is,T=is),St)switch(L){case dr:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Dd:t.blendFunc(t.ONE,t.ONE);break;case b0:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case E0:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:tt("WebGLState: Invalid blending: ",L);break}else switch(L){case dr:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Dd:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case b0:tt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case E0:tt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:tt("WebGLState: Invalid blending: ",L);break}M=null,S=null,R=null,C=null,v.set(0,0,0),A=0,f=L,N=St}return}_e=_e||de,ne=ne||Q,Ce=Ce||pe,(de!==x||_e!==T)&&(t.blendEquationSeparate(be[de],be[_e]),x=de,T=_e),(Q!==M||pe!==S||ne!==R||Ce!==C)&&(t.blendFuncSeparate(at[Q],at[pe],at[ne],at[Ce]),M=Q,S=pe,R=ne,C=Ce),(Te.equals(v)===!1||Nt!==A)&&(t.blendColor(Te.r,Te.g,Te.b,Nt),v.copy(Te),A=Nt),f=L,N=!1}function Ee(L,de){L.side===Gi?le(t.CULL_FACE):ae(t.CULL_FACE);let Q=L.side===bn;de&&(Q=!Q),Je(Q),L.blending===dr&&L.transparent===!1?ee(Zi):ee(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),r.setFunc(L.depthFunc),r.setTest(L.depthTest),r.setMask(L.depthWrite),s.setMask(L.colorWrite);const pe=L.stencilWrite;l.setTest(pe),pe&&(l.setMask(L.stencilWriteMask),l.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),l.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),je(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?ae(t.SAMPLE_ALPHA_TO_COVERAGE):le(t.SAMPLE_ALPHA_TO_COVERAGE)}function Je(L){D!==L&&(L?t.frontFace(t.CW):t.frontFace(t.CCW),D=L)}function nt(L){L!==mb?(ae(t.CULL_FACE),L!==B&&(L===M0?t.cullFace(t.BACK):L===gb?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):le(t.CULL_FACE),B=L}function st(L){L!==Y&&(P&&t.lineWidth(L),Y=L)}function je(L,de,Q){L?(ae(t.POLYGON_OFFSET_FILL),(te!==de||F!==Q)&&(te=de,F=Q,r.getReversed()&&(de=-de),t.polygonOffset(de,Q))):le(t.POLYGON_OFFSET_FILL)}function _t(L){L?ae(t.SCISSOR_TEST):le(t.SCISSOR_TEST)}function wt(L){L===void 0&&(L=t.TEXTURE0+U-1),ie!==L&&(t.activeTexture(L),ie=L)}function O(L,de,Q){Q===void 0&&(ie===null?Q=t.TEXTURE0+U-1:Q=ie);let pe=fe[Q];pe===void 0&&(pe={type:void 0,texture:void 0},fe[Q]=pe),(pe.type!==L||pe.texture!==de)&&(ie!==Q&&(t.activeTexture(Q),ie=Q),t.bindTexture(L,de||ce[L]),pe.type=L,pe.texture=de)}function Kt(){const L=fe[ie];L!==void 0&&L.type!==void 0&&(t.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function it(){try{t.compressedTexImage2D(...arguments)}catch(L){tt("WebGLState:",L)}}function w(){try{t.compressedTexImage3D(...arguments)}catch(L){tt("WebGLState:",L)}}function g(){try{t.texSubImage2D(...arguments)}catch(L){tt("WebGLState:",L)}}function z(){try{t.texSubImage3D(...arguments)}catch(L){tt("WebGLState:",L)}}function G(){try{t.compressedTexSubImage2D(...arguments)}catch(L){tt("WebGLState:",L)}}function q(){try{t.compressedTexSubImage3D(...arguments)}catch(L){tt("WebGLState:",L)}}function re(){try{t.texStorage2D(...arguments)}catch(L){tt("WebGLState:",L)}}function oe(){try{t.texStorage3D(...arguments)}catch(L){tt("WebGLState:",L)}}function j(){try{t.texImage2D(...arguments)}catch(L){tt("WebGLState:",L)}}function Z(){try{t.texImage3D(...arguments)}catch(L){tt("WebGLState:",L)}}function ue(L){return p[L]!==void 0?p[L]:t.getParameter(L)}function Ae(L,de){p[L]!==de&&(t.pixelStorei(L,de),p[L]=de)}function he(L){$e.equals(L)===!1&&(t.scissor(L.x,L.y,L.z,L.w),$e.copy(L))}function se(L){Ve.equals(L)===!1&&(t.viewport(L.x,L.y,L.z,L.w),Ve.copy(L))}function Ne(L,de){let Q=c.get(de);Q===void 0&&(Q=new WeakMap,c.set(de,Q));let pe=Q.get(L);pe===void 0&&(pe=t.getUniformBlockIndex(de,L.name),Q.set(L,pe))}function Ue(L,de){const pe=c.get(de).get(L);o.get(de)!==pe&&(t.uniformBlockBinding(de,pe,L.__bindingPointIndex),o.set(de,pe))}function Be(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),r.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),d={},p={},ie=null,fe={},u={},h=new WeakMap,_=[],E=null,m=!1,f=null,x=null,M=null,S=null,T=null,R=null,C=null,v=new rt(0,0,0),A=0,N=!1,D=null,B=null,Y=null,te=null,F=null,$e.set(0,0,t.canvas.width,t.canvas.height),Ve.set(0,0,t.canvas.width,t.canvas.height),s.reset(),r.reset(),l.reset()}return{buffers:{color:s,depth:r,stencil:l},enable:ae,disable:le,bindFramebuffer:Pe,drawBuffers:xe,useProgram:Ct,setBlending:ee,setMaterial:Ee,setFlipSided:Je,setCullFace:nt,setLineWidth:st,setPolygonOffset:je,setScissorTest:_t,activeTexture:wt,bindTexture:O,unbindTexture:Kt,compressedTexImage2D:it,compressedTexImage3D:w,texImage2D:j,texImage3D:Z,pixelStorei:Ae,getParameter:ue,updateUBOMapping:Ne,uniformBlockBinding:Ue,texStorage2D:re,texStorage3D:oe,texSubImage2D:g,texSubImage3D:z,compressedTexSubImage2D:G,compressedTexSubImage3D:q,scissor:he,viewport:se,reset:Be}}function x3(t,e,n,i,a,s,r){const l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,o=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ct,d=new WeakMap,p=new Set;let u;const h=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(w,g){return _?new OffscreenCanvas(w,g):Xc("canvas")}function m(w,g,z){let G=1;const q=it(w);if((q.width>z||q.height>z)&&(G=z/Math.max(q.width,q.height)),G<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const re=Math.floor(G*q.width),oe=Math.floor(G*q.height);u===void 0&&(u=E(re,oe));const j=g?E(re,oe):u;return j.width=re,j.height=oe,j.getContext("2d").drawImage(w,0,0,re,oe),Oe("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+re+"x"+oe+")."),j}else return"data"in w&&Oe("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),w;return w}function f(w){return w.generateMipmaps}function x(w){t.generateMipmap(w)}function M(w){return w.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?t.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function S(w,g,z,G,q,re=!1){if(w!==null){if(t[w]!==void 0)return t[w];Oe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let oe;G&&(oe=e.get("EXT_texture_norm16"),oe||Oe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=g;if(g===t.RED&&(z===t.FLOAT&&(j=t.R32F),z===t.HALF_FLOAT&&(j=t.R16F),z===t.UNSIGNED_BYTE&&(j=t.R8),z===t.UNSIGNED_SHORT&&oe&&(j=oe.R16_EXT),z===t.SHORT&&oe&&(j=oe.R16_SNORM_EXT)),g===t.RED_INTEGER&&(z===t.UNSIGNED_BYTE&&(j=t.R8UI),z===t.UNSIGNED_SHORT&&(j=t.R16UI),z===t.UNSIGNED_INT&&(j=t.R32UI),z===t.BYTE&&(j=t.R8I),z===t.SHORT&&(j=t.R16I),z===t.INT&&(j=t.R32I)),g===t.RG&&(z===t.FLOAT&&(j=t.RG32F),z===t.HALF_FLOAT&&(j=t.RG16F),z===t.UNSIGNED_BYTE&&(j=t.RG8),z===t.UNSIGNED_SHORT&&oe&&(j=oe.RG16_EXT),z===t.SHORT&&oe&&(j=oe.RG16_SNORM_EXT)),g===t.RG_INTEGER&&(z===t.UNSIGNED_BYTE&&(j=t.RG8UI),z===t.UNSIGNED_SHORT&&(j=t.RG16UI),z===t.UNSIGNED_INT&&(j=t.RG32UI),z===t.BYTE&&(j=t.RG8I),z===t.SHORT&&(j=t.RG16I),z===t.INT&&(j=t.RG32I)),g===t.RGB_INTEGER&&(z===t.UNSIGNED_BYTE&&(j=t.RGB8UI),z===t.UNSIGNED_SHORT&&(j=t.RGB16UI),z===t.UNSIGNED_INT&&(j=t.RGB32UI),z===t.BYTE&&(j=t.RGB8I),z===t.SHORT&&(j=t.RGB16I),z===t.INT&&(j=t.RGB32I)),g===t.RGBA_INTEGER&&(z===t.UNSIGNED_BYTE&&(j=t.RGBA8UI),z===t.UNSIGNED_SHORT&&(j=t.RGBA16UI),z===t.UNSIGNED_INT&&(j=t.RGBA32UI),z===t.BYTE&&(j=t.RGBA8I),z===t.SHORT&&(j=t.RGBA16I),z===t.INT&&(j=t.RGBA32I)),g===t.RGB&&(z===t.UNSIGNED_SHORT&&oe&&(j=oe.RGB16_EXT),z===t.SHORT&&oe&&(j=oe.RGB16_SNORM_EXT),z===t.UNSIGNED_INT_5_9_9_9_REV&&(j=t.RGB9_E5),z===t.UNSIGNED_INT_10F_11F_11F_REV&&(j=t.R11F_G11F_B10F)),g===t.RGBA){const Z=re?Vc:Ze.getTransfer(q);z===t.FLOAT&&(j=t.RGBA32F),z===t.HALF_FLOAT&&(j=t.RGBA16F),z===t.UNSIGNED_BYTE&&(j=Z===ut?t.SRGB8_ALPHA8:t.RGBA8),z===t.UNSIGNED_SHORT&&oe&&(j=oe.RGBA16_EXT),z===t.SHORT&&oe&&(j=oe.RGBA16_SNORM_EXT),z===t.UNSIGNED_SHORT_4_4_4_4&&(j=t.RGBA4),z===t.UNSIGNED_SHORT_5_5_5_1&&(j=t.RGB5_A1)}return(j===t.R16F||j===t.R32F||j===t.RG16F||j===t.RG32F||j===t.RGBA16F||j===t.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function T(w,g){let z;return w?g===null||g===Ti||g===Il?z=t.DEPTH24_STENCIL8:g===Si?z=t.DEPTH32F_STENCIL8:g===Pl&&(z=t.DEPTH24_STENCIL8,Oe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Ti||g===Il?z=t.DEPTH_COMPONENT24:g===Si?z=t.DEPTH_COMPONENT32F:g===Pl&&(z=t.DEPTH_COMPONENT16),z}function R(w,g){return f(w)===!0||w.isFramebufferTexture&&w.minFilter!==rn&&w.minFilter!==fn?Math.log2(Math.max(g.width,g.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?g.mipmaps.length:1}function C(w){const g=w.target;g.removeEventListener("dispose",C),A(g),g.isVideoTexture&&d.delete(g),g.isHTMLTexture&&p.delete(g)}function v(w){const g=w.target;g.removeEventListener("dispose",v),D(g)}function A(w){const g=i.get(w);if(g.__webglInit===void 0)return;const z=w.source,G=h.get(z);if(G){const q=G[g.__cacheKey];q.usedTimes--,q.usedTimes===0&&N(w),Object.keys(G).length===0&&h.delete(z)}i.remove(w)}function N(w){const g=i.get(w);t.deleteTexture(g.__webglTexture);const z=w.source,G=h.get(z);delete G[g.__cacheKey],r.memory.textures--}function D(w){const g=i.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),i.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(g.__webglFramebuffer[G]))for(let q=0;q<g.__webglFramebuffer[G].length;q++)t.deleteFramebuffer(g.__webglFramebuffer[G][q]);else t.deleteFramebuffer(g.__webglFramebuffer[G]);g.__webglDepthbuffer&&t.deleteRenderbuffer(g.__webglDepthbuffer[G])}else{if(Array.isArray(g.__webglFramebuffer))for(let G=0;G<g.__webglFramebuffer.length;G++)t.deleteFramebuffer(g.__webglFramebuffer[G]);else t.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&t.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&t.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let G=0;G<g.__webglColorRenderbuffer.length;G++)g.__webglColorRenderbuffer[G]&&t.deleteRenderbuffer(g.__webglColorRenderbuffer[G]);g.__webglDepthRenderbuffer&&t.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const z=w.textures;for(let G=0,q=z.length;G<q;G++){const re=i.get(z[G]);re.__webglTexture&&(t.deleteTexture(re.__webglTexture),r.memory.textures--),i.remove(z[G])}i.remove(w)}let B=0;function Y(){B=0}function te(){return B}function F(w){B=w}function U(){const w=B;return w>=a.maxTextures&&Oe("WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+a.maxTextures),B+=1,w}function P(w){const g=[];return g.push(w.wrapS),g.push(w.wrapT),g.push(w.wrapR||0),g.push(w.magFilter),g.push(w.minFilter),g.push(w.anisotropy),g.push(w.internalFormat),g.push(w.format),g.push(w.type),g.push(w.generateMipmaps),g.push(w.premultiplyAlpha),g.push(w.flipY),g.push(w.unpackAlignment),g.push(w.colorSpace),g.join()}function X(w,g){const z=i.get(w);if(w.isVideoTexture&&O(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&z.__version!==w.version){const G=w.image;if(G===null)Oe("WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)Oe("WebGLRenderer: Texture marked for update but image is incomplete");else{le(z,w,g);return}}else w.isExternalTexture&&(z.__webglTexture=w.sourceTexture?w.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,z.__webglTexture,t.TEXTURE0+g)}function J(w,g){const z=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){le(z,w,g);return}else w.isExternalTexture&&(z.__webglTexture=w.sourceTexture?w.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,z.__webglTexture,t.TEXTURE0+g)}function ie(w,g){const z=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){le(z,w,g);return}n.bindTexture(t.TEXTURE_3D,z.__webglTexture,t.TEXTURE0+g)}function fe(w,g){const z=i.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&z.__version!==w.version){Pe(z,w,g);return}n.bindTexture(t.TEXTURE_CUBE_MAP,z.__webglTexture,t.TEXTURE0+g)}const Se={[Gd]:t.REPEAT,[Wi]:t.CLAMP_TO_EDGE,[Vd]:t.MIRRORED_REPEAT},Xe={[rn]:t.NEAREST,[Bb]:t.NEAREST_MIPMAP_NEAREST,[vo]:t.NEAREST_MIPMAP_LINEAR,[fn]:t.LINEAR,[af]:t.LINEAR_MIPMAP_NEAREST,[ss]:t.LINEAR_MIPMAP_LINEAR},$e={[Gb]:t.NEVER,[qb]:t.ALWAYS,[Vb]:t.LESS,[Dp]:t.LEQUAL,[kb]:t.EQUAL,[Up]:t.GEQUAL,[Xb]:t.GREATER,[Wb]:t.NOTEQUAL};function Ve(w,g){if(g.type===Si&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===fn||g.magFilter===af||g.magFilter===vo||g.magFilter===ss||g.minFilter===fn||g.minFilter===af||g.minFilter===vo||g.minFilter===ss)&&Oe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(w,t.TEXTURE_WRAP_S,Se[g.wrapS]),t.texParameteri(w,t.TEXTURE_WRAP_T,Se[g.wrapT]),(w===t.TEXTURE_3D||w===t.TEXTURE_2D_ARRAY)&&t.texParameteri(w,t.TEXTURE_WRAP_R,Se[g.wrapR]),t.texParameteri(w,t.TEXTURE_MAG_FILTER,Xe[g.magFilter]),t.texParameteri(w,t.TEXTURE_MIN_FILTER,Xe[g.minFilter]),g.compareFunction&&(t.texParameteri(w,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(w,t.TEXTURE_COMPARE_FUNC,$e[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===rn||g.minFilter!==vo&&g.minFilter!==ss||g.type===Si&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");t.texParameterf(w,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,a.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function K(w,g){let z=!1;w.__webglInit===void 0&&(w.__webglInit=!0,g.addEventListener("dispose",C));const G=g.source;let q=h.get(G);q===void 0&&(q={},h.set(G,q));const re=P(g);if(re!==w.__cacheKey){q[re]===void 0&&(q[re]={texture:t.createTexture(),usedTimes:0},r.memory.textures++,z=!0),q[re].usedTimes++;const oe=q[w.__cacheKey];oe!==void 0&&(q[w.__cacheKey].usedTimes--,oe.usedTimes===0&&N(g)),w.__cacheKey=re,w.__webglTexture=q[re].texture}return z}function ce(w,g,z){return Math.floor(Math.floor(w/z)/g)}function ae(w,g,z,G){const re=w.updateRanges;if(re.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,g.width,g.height,z,G,g.data);else{re.sort((Ae,he)=>Ae.start-he.start);let oe=0;for(let Ae=1;Ae<re.length;Ae++){const he=re[oe],se=re[Ae],Ne=he.start+he.count,Ue=ce(se.start,g.width,4),Be=ce(he.start,g.width,4);se.start<=Ne+1&&Ue===Be&&ce(se.start+se.count-1,g.width,4)===Ue?he.count=Math.max(he.count,se.start+se.count-he.start):(++oe,re[oe]=se)}re.length=oe+1;const j=n.getParameter(t.UNPACK_ROW_LENGTH),Z=n.getParameter(t.UNPACK_SKIP_PIXELS),ue=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,g.width);for(let Ae=0,he=re.length;Ae<he;Ae++){const se=re[Ae],Ne=Math.floor(se.start/4),Ue=Math.ceil(se.count/4),Be=Ne%g.width,L=Math.floor(Ne/g.width),de=Ue,Q=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Be),n.pixelStorei(t.UNPACK_SKIP_ROWS,L),n.texSubImage2D(t.TEXTURE_2D,0,Be,L,de,Q,z,G,g.data)}w.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,j),n.pixelStorei(t.UNPACK_SKIP_PIXELS,Z),n.pixelStorei(t.UNPACK_SKIP_ROWS,ue)}}function le(w,g,z){let G=t.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(G=t.TEXTURE_2D_ARRAY),g.isData3DTexture&&(G=t.TEXTURE_3D);const q=K(w,g),re=g.source;n.bindTexture(G,w.__webglTexture,t.TEXTURE0+z);const oe=i.get(re);if(re.version!==oe.__version||q===!0){if(n.activeTexture(t.TEXTURE0+z),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const Q=Ze.getPrimaries(Ze.workingColorSpace),pe=g.colorSpace===ba?null:Ze.getPrimaries(g.colorSpace),_e=g.colorSpace===ba||Q===pe?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e)}n.pixelStorei(t.UNPACK_ALIGNMENT,g.unpackAlignment);let Z=m(g.image,!1,a.maxTextureSize);Z=Kt(g,Z);const ue=s.convert(g.format,g.colorSpace),Ae=s.convert(g.type);let he=S(g.internalFormat,ue,Ae,g.normalized,g.colorSpace,g.isVideoTexture);Ve(G,g);let se;const Ne=g.mipmaps,Ue=g.isVideoTexture!==!0,Be=oe.__version===void 0||q===!0,L=re.dataReady,de=R(g,Z);if(g.isDepthTexture)he=T(g.format===rs,g.type),Be&&(Ue?n.texStorage2D(t.TEXTURE_2D,1,he,Z.width,Z.height):n.texImage2D(t.TEXTURE_2D,0,he,Z.width,Z.height,0,ue,Ae,null));else if(g.isDataTexture)if(Ne.length>0){Ue&&Be&&n.texStorage2D(t.TEXTURE_2D,de,he,Ne[0].width,Ne[0].height);for(let Q=0,pe=Ne.length;Q<pe;Q++)se=Ne[Q],Ue?L&&n.texSubImage2D(t.TEXTURE_2D,Q,0,0,se.width,se.height,ue,Ae,se.data):n.texImage2D(t.TEXTURE_2D,Q,he,se.width,se.height,0,ue,Ae,se.data);g.generateMipmaps=!1}else Ue?(Be&&n.texStorage2D(t.TEXTURE_2D,de,he,Z.width,Z.height),L&&ae(g,Z,ue,Ae)):n.texImage2D(t.TEXTURE_2D,0,he,Z.width,Z.height,0,ue,Ae,Z.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ue&&Be&&n.texStorage3D(t.TEXTURE_2D_ARRAY,de,he,Ne[0].width,Ne[0].height,Z.depth);for(let Q=0,pe=Ne.length;Q<pe;Q++)if(se=Ne[Q],g.format!==li)if(ue!==null)if(Ue){if(L)if(g.layerUpdates.size>0){const _e=Q0(se.width,se.height,g.format,g.type);for(const ne of g.layerUpdates){const Ce=se.data.subarray(ne*_e/se.data.BYTES_PER_ELEMENT,(ne+1)*_e/se.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Q,0,0,ne,se.width,se.height,1,ue,Ce)}g.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Q,0,0,0,se.width,se.height,Z.depth,ue,se.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,Q,he,se.width,se.height,Z.depth,0,se.data,0,0);else Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ue?L&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,Q,0,0,0,se.width,se.height,Z.depth,ue,Ae,se.data):n.texImage3D(t.TEXTURE_2D_ARRAY,Q,he,se.width,se.height,Z.depth,0,ue,Ae,se.data)}else{Ue&&Be&&n.texStorage2D(t.TEXTURE_2D,de,he,Ne[0].width,Ne[0].height);for(let Q=0,pe=Ne.length;Q<pe;Q++)se=Ne[Q],g.format!==li?ue!==null?Ue?L&&n.compressedTexSubImage2D(t.TEXTURE_2D,Q,0,0,se.width,se.height,ue,se.data):n.compressedTexImage2D(t.TEXTURE_2D,Q,he,se.width,se.height,0,se.data):Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ue?L&&n.texSubImage2D(t.TEXTURE_2D,Q,0,0,se.width,se.height,ue,Ae,se.data):n.texImage2D(t.TEXTURE_2D,Q,he,se.width,se.height,0,ue,Ae,se.data)}else if(g.isDataArrayTexture)if(Ue){if(Be&&n.texStorage3D(t.TEXTURE_2D_ARRAY,de,he,Z.width,Z.height,Z.depth),L)if(g.layerUpdates.size>0){const Q=Q0(Z.width,Z.height,g.format,g.type);for(const pe of g.layerUpdates){const _e=Z.data.subarray(pe*Q/Z.data.BYTES_PER_ELEMENT,(pe+1)*Q/Z.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,pe,Z.width,Z.height,1,ue,Ae,_e)}g.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,ue,Ae,Z.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,he,Z.width,Z.height,Z.depth,0,ue,Ae,Z.data);else if(g.isData3DTexture)Ue?(Be&&n.texStorage3D(t.TEXTURE_3D,de,he,Z.width,Z.height,Z.depth),L&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,ue,Ae,Z.data)):n.texImage3D(t.TEXTURE_3D,0,he,Z.width,Z.height,Z.depth,0,ue,Ae,Z.data);else if(g.isFramebufferTexture){if(Be)if(Ue)n.texStorage2D(t.TEXTURE_2D,de,he,Z.width,Z.height);else{let Q=Z.width,pe=Z.height;for(let _e=0;_e<de;_e++)n.texImage2D(t.TEXTURE_2D,_e,he,Q,pe,0,ue,Ae,null),Q>>=1,pe>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in t){const Q=t.canvas;if(Q.hasAttribute("layoutsubtree")||Q.setAttribute("layoutsubtree","true"),Z.parentNode!==Q){Q.appendChild(Z),p.add(g),Q.onpaint=pe=>{const _e=pe.changedElements;for(const ne of p)_e.includes(ne.image)&&(ne.needsUpdate=!0)},Q.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,Z);else{const _e=t.RGBA,ne=t.RGBA,Ce=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,_e,ne,Ce,Z)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Ne.length>0){if(Ue&&Be){const Q=it(Ne[0]);n.texStorage2D(t.TEXTURE_2D,de,he,Q.width,Q.height)}for(let Q=0,pe=Ne.length;Q<pe;Q++)se=Ne[Q],Ue?L&&n.texSubImage2D(t.TEXTURE_2D,Q,0,0,ue,Ae,se):n.texImage2D(t.TEXTURE_2D,Q,he,ue,Ae,se);g.generateMipmaps=!1}else if(Ue){if(Be){const Q=it(Z);n.texStorage2D(t.TEXTURE_2D,de,he,Q.width,Q.height)}L&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ue,Ae,Z)}else n.texImage2D(t.TEXTURE_2D,0,he,ue,Ae,Z);f(g)&&x(G),oe.__version=re.version,g.onUpdate&&g.onUpdate(g)}w.__version=g.version}function Pe(w,g,z){if(g.image.length!==6)return;const G=K(w,g),q=g.source;n.bindTexture(t.TEXTURE_CUBE_MAP,w.__webglTexture,t.TEXTURE0+z);const re=i.get(q);if(q.version!==re.__version||G===!0){n.activeTexture(t.TEXTURE0+z);const oe=Ze.getPrimaries(Ze.workingColorSpace),j=g.colorSpace===ba?null:Ze.getPrimaries(g.colorSpace),Z=g.colorSpace===ba||oe===j?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Z);const ue=g.isCompressedTexture||g.image[0].isCompressedTexture,Ae=g.image[0]&&g.image[0].isDataTexture,he=[];for(let ne=0;ne<6;ne++)!ue&&!Ae?he[ne]=m(g.image[ne],!0,a.maxCubemapSize):he[ne]=Ae?g.image[ne].image:g.image[ne],he[ne]=Kt(g,he[ne]);const se=he[0],Ne=s.convert(g.format,g.colorSpace),Ue=s.convert(g.type),Be=S(g.internalFormat,Ne,Ue,g.normalized,g.colorSpace),L=g.isVideoTexture!==!0,de=re.__version===void 0||G===!0,Q=q.dataReady;let pe=R(g,se);Ve(t.TEXTURE_CUBE_MAP,g);let _e;if(ue){L&&de&&n.texStorage2D(t.TEXTURE_CUBE_MAP,pe,Be,se.width,se.height);for(let ne=0;ne<6;ne++){_e=he[ne].mipmaps;for(let Ce=0;Ce<_e.length;Ce++){const Te=_e[Ce];g.format!==li?Ne!==null?L?Q&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Ce,0,0,Te.width,Te.height,Ne,Te.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Ce,Be,Te.width,Te.height,0,Te.data):Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Ce,0,0,Te.width,Te.height,Ne,Ue,Te.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Ce,Be,Te.width,Te.height,0,Ne,Ue,Te.data)}}}else{if(_e=g.mipmaps,L&&de){_e.length>0&&pe++;const ne=it(he[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,pe,Be,ne.width,ne.height)}for(let ne=0;ne<6;ne++)if(Ae){L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,he[ne].width,he[ne].height,Ne,Ue,he[ne].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Be,he[ne].width,he[ne].height,0,Ne,Ue,he[ne].data);for(let Ce=0;Ce<_e.length;Ce++){const Nt=_e[Ce].image[ne].image;L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Ce+1,0,0,Nt.width,Nt.height,Ne,Ue,Nt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Ce+1,Be,Nt.width,Nt.height,0,Ne,Ue,Nt.data)}}else{L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,Ne,Ue,he[ne]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Be,Ne,Ue,he[ne]);for(let Ce=0;Ce<_e.length;Ce++){const Te=_e[Ce];L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Ce+1,0,0,Ne,Ue,Te.image[ne]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Ce+1,Be,Ne,Ue,Te.image[ne])}}}f(g)&&x(t.TEXTURE_CUBE_MAP),re.__version=q.version,g.onUpdate&&g.onUpdate(g)}w.__version=g.version}function xe(w,g,z,G,q,re){const oe=s.convert(z.format,z.colorSpace),j=s.convert(z.type),Z=S(z.internalFormat,oe,j,z.normalized,z.colorSpace),ue=i.get(g),Ae=i.get(z);if(Ae.__renderTarget=g,!ue.__hasExternalTextures){const he=Math.max(1,g.width>>re),se=Math.max(1,g.height>>re);q===t.TEXTURE_3D||q===t.TEXTURE_2D_ARRAY?n.texImage3D(q,re,Z,he,se,g.depth,0,oe,j,null):n.texImage2D(q,re,Z,he,se,0,oe,j,null)}n.bindFramebuffer(t.FRAMEBUFFER,w),wt(g)?l.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,G,q,Ae.__webglTexture,0,_t(g)):(q===t.TEXTURE_2D||q>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,G,q,Ae.__webglTexture,re),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ct(w,g,z){if(t.bindRenderbuffer(t.RENDERBUFFER,w),g.depthBuffer){const G=g.depthTexture,q=G&&G.isDepthTexture?G.type:null,re=T(g.stencilBuffer,q),oe=g.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;wt(g)?l.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,_t(g),re,g.width,g.height):z?t.renderbufferStorageMultisample(t.RENDERBUFFER,_t(g),re,g.width,g.height):t.renderbufferStorage(t.RENDERBUFFER,re,g.width,g.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,oe,t.RENDERBUFFER,w)}else{const G=g.textures;for(let q=0;q<G.length;q++){const re=G[q],oe=s.convert(re.format,re.colorSpace),j=s.convert(re.type),Z=S(re.internalFormat,oe,j,re.normalized,re.colorSpace);wt(g)?l.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,_t(g),Z,g.width,g.height):z?t.renderbufferStorageMultisample(t.RENDERBUFFER,_t(g),Z,g.width,g.height):t.renderbufferStorage(t.RENDERBUFFER,Z,g.width,g.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function be(w,g,z){const G=g.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,w),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const q=i.get(g.depthTexture);if(q.__renderTarget=g,(!q.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),G){if(q.__webglInit===void 0&&(q.__webglInit=!0,g.depthTexture.addEventListener("dispose",C)),q.__webglTexture===void 0){q.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,q.__webglTexture),Ve(t.TEXTURE_CUBE_MAP,g.depthTexture);const ue=s.convert(g.depthTexture.format),Ae=s.convert(g.depthTexture.type);let he;g.depthTexture.format===aa?he=t.DEPTH_COMPONENT24:g.depthTexture.format===rs&&(he=t.DEPTH24_STENCIL8);for(let se=0;se<6;se++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,he,g.width,g.height,0,ue,Ae,null)}}else X(g.depthTexture,0);const re=q.__webglTexture,oe=_t(g),j=G?t.TEXTURE_CUBE_MAP_POSITIVE_X+z:t.TEXTURE_2D,Z=g.depthTexture.format===rs?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(g.depthTexture.format===aa)wt(g)?l.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Z,j,re,0,oe):t.framebufferTexture2D(t.FRAMEBUFFER,Z,j,re,0);else if(g.depthTexture.format===rs)wt(g)?l.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Z,j,re,0,oe):t.framebufferTexture2D(t.FRAMEBUFFER,Z,j,re,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function at(w){const g=i.get(w),z=w.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==w.depthTexture){const G=w.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),G){const q=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,G.removeEventListener("dispose",q)};G.addEventListener("dispose",q),g.__depthDisposeCallback=q}g.__boundDepthTexture=G}if(w.depthTexture&&!g.__autoAllocateDepthBuffer)if(z)for(let G=0;G<6;G++)be(g.__webglFramebuffer[G],w,G);else{const G=w.texture.mipmaps;G&&G.length>0?be(g.__webglFramebuffer[0],w,0):be(g.__webglFramebuffer,w,0)}else if(z){g.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(n.bindFramebuffer(t.FRAMEBUFFER,g.__webglFramebuffer[G]),g.__webglDepthbuffer[G]===void 0)g.__webglDepthbuffer[G]=t.createRenderbuffer(),Ct(g.__webglDepthbuffer[G],w,!1);else{const q=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=g.__webglDepthbuffer[G];t.bindRenderbuffer(t.RENDERBUFFER,re),t.framebufferRenderbuffer(t.FRAMEBUFFER,q,t.RENDERBUFFER,re)}}else{const G=w.texture.mipmaps;if(G&&G.length>0?n.bindFramebuffer(t.FRAMEBUFFER,g.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=t.createRenderbuffer(),Ct(g.__webglDepthbuffer,w,!1);else{const q=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=g.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,re),t.framebufferRenderbuffer(t.FRAMEBUFFER,q,t.RENDERBUFFER,re)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function ee(w,g,z){const G=i.get(w);g!==void 0&&xe(G.__webglFramebuffer,w,w.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),z!==void 0&&at(w)}function Ee(w){const g=w.texture,z=i.get(w),G=i.get(g);w.addEventListener("dispose",v);const q=w.textures,re=w.isWebGLCubeRenderTarget===!0,oe=q.length>1;if(oe||(G.__webglTexture===void 0&&(G.__webglTexture=t.createTexture()),G.__version=g.version,r.memory.textures++),re){z.__webglFramebuffer=[];for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0){z.__webglFramebuffer[j]=[];for(let Z=0;Z<g.mipmaps.length;Z++)z.__webglFramebuffer[j][Z]=t.createFramebuffer()}else z.__webglFramebuffer[j]=t.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){z.__webglFramebuffer=[];for(let j=0;j<g.mipmaps.length;j++)z.__webglFramebuffer[j]=t.createFramebuffer()}else z.__webglFramebuffer=t.createFramebuffer();if(oe)for(let j=0,Z=q.length;j<Z;j++){const ue=i.get(q[j]);ue.__webglTexture===void 0&&(ue.__webglTexture=t.createTexture(),r.memory.textures++)}if(w.samples>0&&wt(w)===!1){z.__webglMultisampledFramebuffer=t.createFramebuffer(),z.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let j=0;j<q.length;j++){const Z=q[j];z.__webglColorRenderbuffer[j]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,z.__webglColorRenderbuffer[j]);const ue=s.convert(Z.format,Z.colorSpace),Ae=s.convert(Z.type),he=S(Z.internalFormat,ue,Ae,Z.normalized,Z.colorSpace,w.isXRRenderTarget===!0),se=_t(w);t.renderbufferStorageMultisample(t.RENDERBUFFER,se,he,w.width,w.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+j,t.RENDERBUFFER,z.__webglColorRenderbuffer[j])}t.bindRenderbuffer(t.RENDERBUFFER,null),w.depthBuffer&&(z.__webglDepthRenderbuffer=t.createRenderbuffer(),Ct(z.__webglDepthRenderbuffer,w,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(re){n.bindTexture(t.TEXTURE_CUBE_MAP,G.__webglTexture),Ve(t.TEXTURE_CUBE_MAP,g);for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0)for(let Z=0;Z<g.mipmaps.length;Z++)xe(z.__webglFramebuffer[j][Z],w,g,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Z);else xe(z.__webglFramebuffer[j],w,g,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);f(g)&&x(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(oe){for(let j=0,Z=q.length;j<Z;j++){const ue=q[j],Ae=i.get(ue);let he=t.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(he=w.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(he,Ae.__webglTexture),Ve(he,ue),xe(z.__webglFramebuffer,w,ue,t.COLOR_ATTACHMENT0+j,he,0),f(ue)&&x(he)}n.unbindTexture()}else{let j=t.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(j=w.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(j,G.__webglTexture),Ve(j,g),g.mipmaps&&g.mipmaps.length>0)for(let Z=0;Z<g.mipmaps.length;Z++)xe(z.__webglFramebuffer[Z],w,g,t.COLOR_ATTACHMENT0,j,Z);else xe(z.__webglFramebuffer,w,g,t.COLOR_ATTACHMENT0,j,0);f(g)&&x(j),n.unbindTexture()}w.depthBuffer&&at(w)}function Je(w){const g=w.textures;for(let z=0,G=g.length;z<G;z++){const q=g[z];if(f(q)){const re=M(w),oe=i.get(q).__webglTexture;n.bindTexture(re,oe),x(re),n.unbindTexture()}}}const nt=[],st=[];function je(w){if(w.samples>0){if(wt(w)===!1){const g=w.textures,z=w.width,G=w.height;let q=t.COLOR_BUFFER_BIT;const re=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,oe=i.get(w),j=g.length>1;if(j)for(let ue=0;ue<g.length;ue++)n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);const Z=w.texture.mipmaps;Z&&Z.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let ue=0;ue<g.length;ue++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(q|=t.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(q|=t.STENCIL_BUFFER_BIT)),j){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,oe.__webglColorRenderbuffer[ue]);const Ae=i.get(g[ue]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ae,0)}t.blitFramebuffer(0,0,z,G,0,0,z,G,q,t.NEAREST),o===!0&&(nt.length=0,st.length=0,nt.push(t.COLOR_ATTACHMENT0+ue),w.depthBuffer&&w.resolveDepthBuffer===!1&&(nt.push(re),st.push(re),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,st)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,nt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),j)for(let ue=0;ue<g.length;ue++){n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.RENDERBUFFER,oe.__webglColorRenderbuffer[ue]);const Ae=i.get(g[ue]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.TEXTURE_2D,Ae,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&o){const g=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[g])}}}function _t(w){return Math.min(a.maxSamples,w.samples)}function wt(w){const g=i.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function O(w){const g=r.render.frame;d.get(w)!==g&&(d.set(w,g),w.update())}function Kt(w,g){const z=w.colorSpace,G=w.format,q=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||z!==Gc&&z!==ba&&(Ze.getTransfer(z)===ut?(G!==li||q!==Qn)&&Oe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):tt("WebGLTextures: Unsupported texture color space:",z)),g}function it(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=U,this.resetTextureUnits=Y,this.getTextureUnits=te,this.setTextureUnits=F,this.setTexture2D=X,this.setTexture2DArray=J,this.setTexture3D=ie,this.setTextureCube=fe,this.rebindTextures=ee,this.setupRenderTarget=Ee,this.updateRenderTargetMipmap=Je,this.updateMultisampleRenderTarget=je,this.setupDepthRenderbuffer=at,this.setupFrameBufferTexture=xe,this.useMultisampledRTT=wt,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function v3(t,e){function n(i,a=ba){let s;const r=Ze.getTransfer(a);if(i===Qn)return t.UNSIGNED_BYTE;if(i===Ap)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Rp)return t.UNSIGNED_SHORT_5_5_5_1;if(i===P_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===I_)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===L_)return t.BYTE;if(i===O_)return t.SHORT;if(i===Pl)return t.UNSIGNED_SHORT;if(i===Tp)return t.INT;if(i===Ti)return t.UNSIGNED_INT;if(i===Si)return t.FLOAT;if(i===ia)return t.HALF_FLOAT;if(i===z_)return t.ALPHA;if(i===B_)return t.RGB;if(i===li)return t.RGBA;if(i===aa)return t.DEPTH_COMPONENT;if(i===rs)return t.DEPTH_STENCIL;if(i===F_)return t.RED;if(i===Cp)return t.RED_INTEGER;if(i===vs)return t.RG;if(i===wp)return t.RG_INTEGER;if(i===Np)return t.RGBA_INTEGER;if(i===sc||i===rc||i===lc||i===oc)if(r===ut)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===sc)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===rc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===lc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===oc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===sc)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===rc)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===lc)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===oc)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===kd||i===Xd||i===Wd||i===qd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===kd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Xd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Wd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===qd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===jd||i===Yd||i===Zd||i===Kd||i===Qd||i===Fc||i===Jd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===jd||i===Yd)return r===ut?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Zd)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Kd)return s.COMPRESSED_R11_EAC;if(i===Qd)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Fc)return s.COMPRESSED_RG11_EAC;if(i===Jd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===$d||i===eh||i===th||i===nh||i===ih||i===ah||i===sh||i===rh||i===lh||i===oh||i===ch||i===uh||i===fh||i===dh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===$d)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===eh)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===th)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===nh)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===ih)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ah)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===sh)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===rh)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===lh)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===oh)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ch)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===uh)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===fh)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===dh)return r===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===hh||i===ph||i===mh)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===hh)return r===ut?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ph)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===mh)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===gh||i===xh||i===Hc||i===vh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===gh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===xh)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Hc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===vh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Il?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const _3=`
void main() {
